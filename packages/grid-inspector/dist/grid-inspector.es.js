...
const GridSystemContext = reactExports.createContext(void 0);
...
function GridSystemProvider({
  ...
  const ic2 = initialConfig;
  const persisted = loadPersistedState();
  const [overlay, setOverlayState] = reactExports.useState({
    columns: ((_a = persisted == null ? void 0 : persisted.overlay) == null ? void 0 : _a.columns) ?? ((_b = ic2 == null ? void 0 : ic2.overlay) == null ? void 0 : _b.columns) ?? 12,
    gutter: ((_c = persisted == null ? void 0 : persisted.overlay) == null ? void 0 : _c.gutter) ?? ((_d = ic2 == null ? void 0 : ic2.overlay) == null ? void 0 : _d.gutter) ?? { x: 16, y: 16 },
    margin: ((_e = persisted == null ? void 0 : persisted.overlay) == null ? void 0 : _e.margin) ?? ((_f = ic2 == null ? void 0 : ic2.overlay) == null ? void 0 : _f.margin) ?? { x: 16, y: 16 },
    padding: ((_g = persisted == null ? void 0 : persisted.overlay) == null ? void 0 : _g.padding) ?? ((_h = ic2 == null ? void 0 : ic2.overlay) == null ? void 0 : _h.padding) ?? { x: 24, y: 24 }
  });
  const [component, setComponentState] = reactExports.useState({
    gutter: ((_i = persisted == null ? void 0 : persisted.component) == null ? void 0 : _i.gutter) ?? ((_j = ic2 == null ? void 0 : ic2.layout) == null ? void 0 : _j.gutter) ?? { x: 16, y: 16 },
  ...
  const [brand, setBrand] = reactExports.useState((persisted == null ? void 0 : persisted.brand) ?? void 0);
  const [violations, setViolations] = reactExports.useState([]);
  const [highlightedElementIndex, setHighlightedElementIndex] = reactExports.useState(null);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(GridSystemContext.Provider, { value, children });
}
function useGridSystem() {
  const context = reactExports.useContext(GridSystemContext);
  if (!context) {
...
const NestedGridContext = reactExports.createContext(null);
...
function removeElementGridVars(element) {
  ELEMENT_GRID_VARS.forEach((v2) => element.style.removeProperty(v2));
  delete element.dataset.gridInspectorKey;
}
function NestedGridProvider({ children }) {
  const [selectedElement, setSelectedElementState] = reactExports.useState(null);
  const [isSelectionMode, setIsSelectionMode] = reactExports.useState(false);
  const [elementGridConfigs, setElementGridConfigs] = reactExports.useState(/* @__PURE__ */ new Map());
...
function useNestedGrid() {
  const context = reactExports.useContext(NestedGridContext);
  if (!context) {
...
function Tabs({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContext.Provider, { value: { value, onValueChange: handleChange }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { "data-slot": "tabs", className: cn("flex flex-col gap-2", className), children }) });
}
...
function TabsTrigger({
  ...
  const { value: activeValue, onValueChange } = reactExports.useContext(TabsContext);
...
function TabsContent({
  ...
  const { value: activeValue } = reactExports.useContext(TabsContext);
...
const AccordionItemContext = reactExports.createContext({
  value: "",
  isOpen: false
});
function Accordion({
  ...
  const [openItems, setOpenItems] = reactExports.useState(initial);
  const toggle = (value) => {
    if (type === "single") {
      setOpenItems((prev) => prev.includes(value) ? [] : [value]);
    } else {
      setOpenItems(
        (prev) => prev.includes(value) ? prev.filter((v2) => v2 !== value) : [...prev, value]
      );
    }
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AccordionContext.Provider, { value: { openItems, toggle, type }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { "data-slot": "accordion", className, children }) });
}
function AccordionItem({
  ...
  const { openItems } = reactExports.useContext(AccordionContext);
  const isOpen = openItems.includes(value);
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AccordionItemContext.Provider, { value: { value, isOpen }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { "data-slot": "accordion-item", className: cn("border-b last:border-b-0", className), children }) });
}
function AccordionTrigger({
  className,
  children
}) {
  const { toggle } = reactExports.useContext(AccordionContext);
  const { value, isOpen } = reactExports.useContext(AccordionItemContext);
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "button",
    {
      type: "button",
...
function AccordionContent({
  ...
  const { isOpen } = reactExports.useContext(AccordionItemContext);
...
function Slider({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative h-1.5 w-full rounded-full bg-slate-200 overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
...
function ToggleGroup({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(ToggleGroupContext.Provider, { value: { value, onValueChange: onValueChange ?? (() => {
  }) }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
...
function ToggleGroupItem({
  ...
  const { value: selectedValue, onValueChange } = reactExports.useContext(ToggleGroupContext);
...
function Tooltip({ children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative inline-block group", "data-slot": "tooltip", children });
}
...
function FloatingGridInspector() {
  ...
  reactExports.useEffect(() => {
    ...
    check();
    const id2 = setInterval(check, 5e3);
    return () => clearInterval(id2);
  }, []);
  const exportReport = reactExports.useCallback(() => {
    const verdict = violations.some((v2) => v2.severity === "critical" || v2.severity === "high") ? "non-compliant" : violations.length > 0 ? "warnings" : "compliant";
    const report = {
      ...
      violations: violations.map((v2) => ({
        ...
        type: v2.type,
        message: v2.message,
        affectedProperty: v2.affectedProperty ?? null,
        affectedValue: v2.affectedValue ?? null
      }))
    };
  ...
  const [overlayOpacity, setOverlayOpacity] = reactExports.useState(60);
  const [showColumns, setShowColumns] = reactExports.useState(true);
  const [showPaddingZonesX, setShowPaddingZonesX] = reactExports.useState(true);
  const [showPaddingZonesY, setShowPaddingZonesY] = reactExports.useState(true);
  const [showMarginBoundariesX, setShowMarginBoundariesX] = reactExports.useState(true);
  const [showMarginBoundariesY, setShowMarginBoundariesY] = reactExports.useState(true);
  const [showBaselineGrid, setShowBaselineGrid] = reactExports.useState(true);
  const [containerType, setContainerType] = reactExports.useState("fluid");
  const [breakpoint, setBreakpoint] = reactExports.useState("desktop");
  const [baselineGrid, setBaselineGrid] = reactExports.useState("8px");
  const [densityMode, setDensityMode] = reactExports.useState("comfortable");
  const columnOptions = [4, 6, 8, 10, 12, 16];
  reactExports.useEffect(() => {
    const id2 = "grid-inspector-portal-zindex";
    ...
    return () => {
      var _a2;
      (_a2 = document.getElementById(id2)) == null ? void 0 : _a2.remove();
    };
  }, []);
  reactExports.useEffect(() => {
    var _a2;
  ...
  reactExports.useEffect(() => {
    ...
    const handleClick = (e) => {
      ...
      let el2 = e.target;
      let target = el2;
      while (el2 && el2.tagName !== "BODY" && el2.tagName !== "HTML") {
        if (el2.id && el2.id.length > 0 || el2.hasAttribute("data-grid-debug") || el2.hasAttribute("data-grid-rows")) {
          target = el2;
          break;
        }
  ...
  const handleBreakpointChange = (bp) => {
    if (!bp) return;
    setBreakpoint(bp);
    const p2 = BREAKPOINT_PRESETS[bp];
    if (!p2) return;
    setSimulatedViewportWidth(p2.viewportPx);
    setOverlay({
      columns: p2.columns,
      gutter: { x: p2.gutterX, y: p2.gutterY },
      margin: { x: p2.marginX, y: p2.marginY },
      padding: { x: p2.paddingX, y: p2.paddingY }
    });
    setComponent({
      gutter: { x: p2.gutterX, y: p2.gutterY },
      margin: { x: p2.marginX, y: p2.marginY },
  ...
  if (!isVisible) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(Grid3x3, { size: 20 })
      }
    );
  }
  if (panelSize === "minimized") {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-3 border-b border-slate-200 bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                title: "Expand Panel",
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronLeft, { size: 16, className: "text-slate-700" })
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                className: "p-2 hover:bg-white rounded-lg transition-all",
                title: "Hide Panel",
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(X, { size: 16, className: "text-slate-400" })
              }
            )
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-2 space-y-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                title: "Layout Grid",
                onClick: () => setPanelSize("expanded"),
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(Box, { size: 20, className: "text-emerald-600 mx-auto" })
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                title: "Overlay Grid",
                onClick: () => setPanelSize("expanded"),
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(Eye, { size: 20, className: "text-purple-600 mx-auto" })
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                title: "Visibility",
                onClick: () => setPanelSize("expanded"),
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(Eye, { size: 20, className: "text-blue-600 mx-auto" })
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                title: "Advanced",
                onClick: () => setPanelSize("expanded"),
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(Layers, { size: 20, className: "text-indigo-600 mx-auto" })
              }
            )
          ] })
        ]
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `px-5 py-3 border-b border-slate-200 flex-shrink-0 ${isEditingElement ? "bg-gradient-to-br from-green-50 via-emerald-50 to-green-50" : "bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50"}`, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `w-8 h-8 rounded-lg flex items-center justify-center ${isEditingElement ? "bg-gradient-to-br from-green-600 to-emerald-600" : "bg-gradient-to-br from-blue-600 to-purple-600"}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Grid3x3, { className: "text-white", size: 16 }) }),
            panelSize === "expanded" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-bold text-slate-900 text-sm flex items-center gap-2", children: [
                "Grid Inspector",
                isEditingElement && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-bold bg-green-600 text-white px-2 py-0.5 rounded animate-pulse", children: "EDITING ELEMENT" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-slate-600 flex items-center gap-1.5", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "span",
                  {
                    ...
                    children: [
                      mcpConnected ? /* @__PURE__ */ jsxRuntimeExports.jsx(Wifi, { size: 9 }) : /* @__PURE__ */ jsxRuntimeExports.jsx(WifiOff, { size: 9 }),
                      "MCP"
                    ]
                  }
                )
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1", children: [
            panelSize === "expanded" && /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                onClick: () => setPanelSize("minimized"),
                className: "p-1.5 hover:bg-white rounded-lg transition-all",
                title: "Minimize",
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronRight, { size: 14, className: "text-slate-600" })
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                className: "p-1.5 hover:bg-white rounded-lg transition-all",
                title: "Close",
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(X, { size: 14, className: "text-slate-400" })
              }
            )
          ] })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { defaultValue: "layout", className: "w-full flex-1 flex flex-col min-h-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsList, { className: "w-full grid grid-cols-5 rounded-none border-b border-slate-200 bg-slate-50 h-auto p-0 flex-shrink-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              TabsTrigger,
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-r from-emerald-500/0 via-emerald-500/5 to-emerald-500/0 translate-x-[-100%] group-hover:translate-x-[100%] transition-transform duration-700 ease-out" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-1 relative z-10 transition-transform duration-200 group-hover:scale-110 group-active:scale-95", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Box, { size: 14, className: "text-emerald-600 transition-all duration-200 group-hover:drop-shadow-[0_0_6px_rgba(16,185,129,0.3)]" }),
                    panelSize === "expanded" && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold transition-colors duration-200", children: "Layout" })
                  ] })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              TabsTrigger,
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-r from-purple-500/0 via-purple-500/5 to-purple-500/0 translate-x-[-100%] group-hover:translate-x-[100%] transition-transform duration-700 ease-out" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-1 relative z-10 transition-transform duration-200 group-hover:scale-110 group-active:scale-95", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Eye, { size: 14, className: "text-purple-600 transition-all duration-200 group-hover:drop-shadow-[0_0_6px_rgba(168,85,247,0.3)]" }),
                    panelSize === "expanded" && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold transition-colors duration-200", children: "Overlay" })
                  ] })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              TabsTrigger,
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-r from-blue-500/0 via-blue-500/5 to-blue-500/0 translate-x-[-100%] group-hover:translate-x-[100%] transition-transform duration-700 ease-out" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-1 relative z-10 transition-transform duration-200 group-hover:scale-110 group-active:scale-95", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Eye, { size: 14, className: "text-blue-600 transition-all duration-200 group-hover:drop-shadow-[0_0_6px_rgba(37,99,235,0.3)]" }),
                    panelSize === "expanded" && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold transition-colors duration-200", children: "Show" })
                  ] })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              TabsTrigger,
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-r from-indigo-500/0 via-indigo-500/5 to-indigo-500/0 translate-x-[-100%] group-hover:translate-x-[100%] transition-transform duration-700 ease-out" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-1 relative z-10 transition-transform duration-200 group-hover:scale-110 group-active:scale-95", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Layers, { size: 14, className: "text-indigo-600 transition-all duration-200 group-hover:drop-shadow-[0_0_6px_rgba(99,102,241,0.3)]" }),
                    panelSize === "expanded" && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold transition-colors duration-200", children: "Adv" })
                  ] })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              TabsTrigger,
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-r from-red-500/0 via-red-500/5 to-red-500/0 translate-x-[-100%] group-hover:translate-x-[100%] transition-transform duration-700 ease-out" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-1 relative z-10 transition-transform duration-200 group-hover:scale-110 group-active:scale-95", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(TriangleAlert, { size: 14, className: violations.length > 0 ? "text-red-500" : "text-slate-400" }),
                      violations.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute -top-2 -right-2 w-4 h-4 bg-red-500 text-white text-[9px] font-bold rounded-full flex items-center justify-center leading-none", children: violations.length > 9 ? "9+" : violations.length })
                    ] }),
                    panelSize === "expanded" && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-xs font-semibold transition-colors duration-200 ${violations.length > 0 ? "text-red-600" : ""}`, children: "Alerts" })
                  ] })
                ]
              }
            )
            ...
            isEditingElement && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-4 mt-4 mb-3 p-3 bg-gradient-to-r from-green-50 to-emerald-50 border-2 border-green-400 rounded-lg", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-bold text-green-900", children: "ESCOPO DO ELEMENTO" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-green-600 mt-1", children: "Sliders afetam apenas este elemento e seus filhos" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Accordion, { type: "multiple", defaultValue: ["spacing-x", "spacing-y"], className: "w-full", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(AccordionItem, { value: "grid-structure", className: "border-b border-slate-100", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(AccordionTrigger, { className: "px-4 py-2.5 hover:bg-emerald-50/50 text-xs font-semibold", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Grid3x3, { size: 14, className: "text-emerald-600" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Grid Structure" })
                ] }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(AccordionContent, { className: "px-4 pb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
                  ...
                  panelSize === "expanded" && /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-[0.3] space-y-1.5", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs(Label, { htmlFor: "auto-column", className: "text-xs font-semibold text-slate-700 flex items-center gap-1", children: [
                        "Auto Column",
                        /* @__PURE__ */ jsxRuntimeExports.jsxs(Tooltip, { children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(TooltipTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", className: "p-0.5 hover:bg-slate-200 rounded transition-colors", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Info, { size: 12, className: "text-slate-500" }) }) }),
                          /* @__PURE__ */ jsxRuntimeExports.jsxs(
                            TooltipContent,
                            {
                              side: "right",
                              ...
                              sideOffset: 8,
                              children: [
                                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-bold mb-1.5", children: autoColumnWidth ? "✓ Columns Flexíveis (1fr)" : "✗ Columns Fixas" }),
                                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs opacity-90", children: autoColumnWidth ? "Colunas se adaptam ao espaço disponível (grid-template-columns: repeat(N, 1fr))" : `Colunas têm largura fixa calculada: ${Math.floor(
                                  (() => {
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-1", children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-[10px] font-bold transition-colors ${autoColumnWidth ? "text-emerald-600" : "text-slate-400"}`, children: autoColumnWidth ? "1fr" : "Fixed" })
                      ] })
                    ] })
                  ] }) })
                ] }) })
              ] }),
              panelSize === "expanded" && /* @__PURE__ */ jsxRuntimeExports.jsxs(AccordionItem, { value: "breakpoints", className: "border-b border-slate-100", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(AccordionTrigger, { className: "px-4 py-2.5 hover:bg-violet-50/50 text-xs font-semibold", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Layers, { size: 14, className: "text-violet-600" }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(AccordionContent, { className: "px-4 pb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(ToggleGroup, { type: "single", value: breakpoint, onValueChange: handleBreakpointChange, className: "grid grid-cols-2 sm:grid-cols-4 gap-1.5", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(ToggleGroupItem, { value: "mobile", className: "text-xs h-auto py-1.5 px-2 data-[state=on]:bg-violet-600 data-[state=on]:text-white flex flex-col items-center gap-0.5 leading-tight", children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] opacity-70", children: "375px" })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(ToggleGroupItem, { value: "tablet", className: "text-xs h-auto py-1.5 px-2 data-[state=on]:bg-violet-600 data-[state=on]:text-white flex flex-col items-center gap-0.5 leading-tight", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Tablet" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] opacity-70", children: "768px" })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(ToggleGroupItem, { value: "desktop", className: "text-xs h-auto py-1.5 px-2 data-[state=on]:bg-violet-600 data-[state=on]:text-white flex flex-col items-center gap-0.5 leading-tight", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Desktop" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] opacity-70", children: "1440px" })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(ToggleGroupItem, { value: "ultra", className: "text-xs h-auto py-1.5 px-2 data-[state=on]:bg-violet-600 data-[state=on]:text-white flex flex-col items-center gap-0.5 leading-tight", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Ultra" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] opacity-70", children: "1920px" })
                    ] })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-slate-500", children: "🔧 Define max-width do container" })
                ] }) })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(AccordionItem, { value: "spacing-x", className: "border-b border-slate-100", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(AccordionTrigger, { className: "px-4 py-2.5 hover:bg-blue-50/50 text-xs font-semibold", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowLeftRight, { size: 14, className: "text-blue-600" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Spacing X" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs bg-blue-100 text-blue-700 px-1.5 py-0.5 rounded-full font-bold", children: "Horizontal" })
                ] }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(AccordionContent, { className: "px-4 pb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 p-2.5 bg-blue-50/50 rounded-lg border border-blue-100", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs font-mono font-bold text-blue-700 bg-blue-100 px-2 py-0.5 rounded whitespace-nowrap", children: [
                      componentGutter,
                      "px"
                    ] })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 p-2.5 bg-green-50/50 rounded-lg border border-green-100", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs font-mono font-bold text-green-700 bg-green-100 px-2 py-0.5 rounded whitespace-nowrap", children: [
                      componentPadding,
                      "px"
                    ] })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 p-2.5 bg-orange-50/50 rounded-lg border border-orange-100", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs font-mono font-bold text-orange-700 bg-orange-100 px-2 py-0.5 rounded whitespace-nowrap", children: [
                      componentMargin,
                      "px"
                    ] })
                  ] })
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(AccordionItem, { value: "spacing-y", className: "border-0", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(AccordionTrigger, { className: "px-4 py-2.5 hover:bg-rose-50/50 text-xs font-semibold", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowUpDown, { size: 14, className: "text-rose-600" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Spacing Y" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs bg-rose-100 text-rose-700 px-1.5 py-0.5 rounded-full font-bold", children: "Vertical" })
                ] }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(AccordionContent, { className: "px-4 pb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 p-2.5 bg-blue-50/50 rounded-lg border border-blue-100", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs font-semibold text-blue-900 flex items-center gap-1.5 whitespace-nowrap", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsContent, { value: "overlay", className: "p-0 m-0 flex-1 overflow-y-auto", children: [
            isEditingElement && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-4 mt-4 mb-3 p-3 bg-gradient-to-r from-green-50 to-emerald-50 border-2 border-green-400 rounded-lg", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-2 h-2 bg-green-500 rounded-full animate-pulse" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-bold text-green-900", children: "EDITING ELEMENT GRID" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-green-700", children: [
                "🎯 ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: selectedElementInfo == null ? void 0 : selectedElementInfo.tagName }),
                " #",
                selectedElementInfo == null ? void 0 : selectedElementInfo.id
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 mt-2 text-[10px] font-mono", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "bg-blue-100 text-blue-700 px-1.5 py-0.5 rounded", children: [
                  gridColumns,
                  " cols"
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "bg-blue-100 text-blue-700 px-1.5 py-0.5 rounded", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "bg-orange-100 text-orange-700 px-1.5 py-0.5 rounded", children: [
                  gridMargin,
                  "px margin"
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-green-600 mt-2", children: "Changes apply only to this element" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Accordion, { type: "multiple", defaultValue: ["overlay-spacing-x", "overlay-spacing-y"], className: "w-full", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(AccordionItem, { value: "overlay-spacing-x", className: "border-b border-slate-100", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(AccordionTrigger, { className: "px-4 py-2.5 hover:bg-blue-50/50 text-xs font-semibold", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowLeftRight, { size: 14, className: "text-blue-600" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Overlay X" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs bg-blue-100 text-blue-700 px-1.5 py-0.5 rounded-full font-bold", children: "Horizontal" })
                ] }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(AccordionContent, { className: "px-4 pb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 p-2.5 bg-blue-50/50 rounded-lg border border-blue-100", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(AccordionItem, { value: "overlay-spacing-y", className: "border-0", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(AccordionTrigger, { className: "px-4 py-2.5 hover:bg-rose-50/50 text-xs font-semibold", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowUpDown, { size: 14, className: "text-rose-600" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Overlay Y" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs bg-rose-100 text-rose-700 px-1.5 py-0.5 rounded-full font-bold", children: "Vertical" })
                ] }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(AccordionContent, { className: "px-4 pb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 p-2.5 bg-blue-50/50 rounded-lg border border-blue-100", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "visibility", className: "p-0 m-0 flex-1 overflow-y-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Accordion, { type: "multiple", defaultValue: ["visibility-main", "visibility-layers", "element-grid-visibility"], className: "w-full", children: [
            isEditingElement && /* @__PURE__ */ jsxRuntimeExports.jsxs(AccordionItem, { value: "element-grid-visibility", className: "border-b border-slate-100 bg-green-50/30", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(AccordionTrigger, { className: "px-4 py-2.5 hover:bg-green-100/50 text-xs font-semibold", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-2 h-2 bg-green-500 rounded-full animate-pulse" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-green-900", children: "Element Grid Visibility" })
              ] }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(AccordionContent, { className: "px-4 pb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-2 bg-green-100 border border-green-300 rounded-lg", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-green-800 font-semibold mb-2", children: [
                  "🎯 Editing: ",
                  /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: selectedElementInfo == null ? void 0 : selectedElementInfo.tagName }),
                  " #",
                  selectedElementInfo == null ? void 0 : selectedElementInfo.id
                ] }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between p-2 bg-blue-50 rounded-lg border border-blue-200", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "element-show-columns", className: "text-xs font-semibold text-blue-900", children: "Show Columns" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Switch,
                    {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between p-2 bg-orange-50 rounded-lg border border-orange-200", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "element-show-margins", className: "text-xs font-semibold text-orange-900", children: "Show Margins" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Switch,
                    {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(AccordionItem, { value: "visibility-main", className: "border-b border-slate-100", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(AccordionTrigger, { className: "px-4 py-2.5 hover:bg-blue-50/50 text-xs font-semibold", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Layers, { size: 14, className: "text-blue-600" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Overlay Settings" })
              ] }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(AccordionContent, { className: "px-4 pb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-[0.7] space-y-1.5", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs font-mono font-bold text-slate-700 bg-slate-200 px-2 py-0.5 rounded min-w-[45px] text-center", children: [
                      overlayOpacity,
                      "%"
                    ] })
                  ] })
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-[0.3] space-y-1.5", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "show-grid", className: "text-xs font-semibold text-slate-700", children: "Show Overlay" }),
            ...
            showGrid && panelSize === "expanded" && /* @__PURE__ */ jsxRuntimeExports.jsxs(AccordionItem, { value: "visibility-layers", className: "border-b border-slate-100", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(AccordionTrigger, { className: "px-4 py-2.5 hover:bg-purple-50/50 text-xs font-semibold", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Layers, { size: 14, className: "text-purple-600" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Layer Visibility" })
              ] }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(AccordionContent, { className: "px-4 pb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 pb-1.5 border-b border-blue-100", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowLeftRight, { size: 12, className: "text-blue-600" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-bold text-blue-700", children: "Horizontal (X)" })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between p-2 bg-rose-50 rounded-lg border border-rose-200", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(Label, { htmlFor: "show-columns", className: "text-xs font-semibold text-rose-900 flex items-center gap-2", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-3 h-3 bg-rose-200/40 border border-rose-400 rounded" }),
                      "Columns"
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      Switch,
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between p-2 bg-green-50 rounded-lg border border-green-200", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(Label, { htmlFor: "show-padding", className: "text-xs font-semibold text-green-900 flex items-center gap-2", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-3 h-3 bg-green-200/60 border border-green-400 rounded" }),
                      "Padding L/R"
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      Switch,
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between p-2 bg-orange-50 rounded-lg border border-orange-200", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(Label, { htmlFor: "show-margin", className: "text-xs font-semibold text-orange-900 flex items-center gap-2", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-3 h-3 border-2 border-dashed border-orange-500 rounded" }),
                      "Margin L/R"
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      Switch,
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 pb-1.5 border-b border-rose-100", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowUpDown, { size: 12, className: "text-rose-600" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-bold text-rose-700", children: "Vertical (Y)" })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between p-2 bg-rose-50 rounded-lg border border-rose-200", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(Label, { htmlFor: "show-rows", className: "text-xs font-semibold text-rose-900 flex items-center gap-2", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-3 h-3 bg-rose-200/40 border border-rose-400 rounded" }),
                      "Rows"
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between p-2 bg-green-50 rounded-lg border border-green-200", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(Label, { htmlFor: "show-padding-y", className: "text-xs font-semibold text-green-900 flex items-center gap-2", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between p-2 bg-orange-50 rounded-lg border border-orange-200", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(Label, { htmlFor: "show-margin-y", className: "text-xs font-semibold text-orange-900 flex items-center gap-2", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-3 h-3 border-2 border-dashed border-orange-500 rounded" }),
                      "Margin T/B"
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 pb-1.5 border-b border-violet-100", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowUpDown, { size: 12, className: "text-violet-600" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-bold text-violet-700", children: "Baseline Grid" })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between p-2 bg-violet-50 rounded-lg border border-violet-200", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(Label, { htmlFor: "show-baseline", className: "text-xs font-semibold text-violet-900 flex items-center gap-2", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-3 h-3 border border-violet-400 rounded", style: { backgroundImage: "repeating-linear-gradient(0deg, transparent, transparent 3px, rgba(139, 92, 246, 0.3) 3px, rgba(139, 92, 246, 0.3) 4px)" } }),
                      "Grid Lines (",
                      baselineGrid,
                      ")"
                    ] }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-slate-500 pt-2", children: "🔧 Controla quais camadas do overlay são visíveis em cada eixo" })
              ] }) })
            ] })
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "advanced", className: "p-0 m-0 flex-1 overflow-y-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Accordion, { type: "multiple", defaultValue: ["advanced-brand"], className: "w-full", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(AccordionItem, { value: "advanced-brand", className: "border-b border-slate-100", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(AccordionTrigger, { className: "px-4 py-2.5 hover:bg-pink-50/50 text-xs font-semibold", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Brand DSS" }),
                brand && /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(AccordionContent, { className: "px-4 pb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-slate-500", children: [
                  "Define ",
                  /* @__PURE__ */ jsxRuntimeExports.jsx("code", { className: "font-mono bg-slate-100 px-1 rounded", children: "data-brand" }),
                  " em",
                  " ",
                  /* @__PURE__ */ jsxRuntimeExports.jsx("code", { className: "font-mono bg-slate-100 px-1 rounded", children: "<html>" }),
                  " e habilita validação de tokens de cor por marca."
                ] })
              ] }) })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(AccordionItem, { value: "advanced-grid", className: "border-b border-slate-100", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(AccordionTrigger, { className: "px-4 py-2.5 hover:bg-indigo-50/50 text-xs font-semibold", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Grid3x3, { size: 14, className: "text-indigo-600" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Advanced Grid" })
              ] }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(AccordionContent, { className: "px-4 pb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between p-2 bg-indigo-50 rounded-lg border border-indigo-200", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "nested-grid", className: "text-xs font-semibold text-indigo-900", children: "🎯 Selection Mode" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-indigo-700", children: "Clique para selecionar elementos" })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Switch,
                    {
                ...
                isEditingElement && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 bg-green-50 border-2 border-green-400 rounded-lg space-y-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-2 h-2 bg-green-500 rounded-full animate-pulse" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-bold text-green-900", children: "ELEMENTO ATIVO" })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "button",
                      {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-green-800", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Tag:" }),
                    " <",
                    selectedElementInfo == null ? void 0 : selectedElementInfo.tagName,
                    ">"
                  ] }),
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-green-800 break-all", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-green-600 border-t border-green-200 pt-2", children: "↕ Controles Layout e Overlay aplicam-se a este escopo" })
                ] }),
                isSelectionMode && !isEditingElement && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-3 bg-blue-50 border border-blue-200 rounded-lg", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-blue-700", children: "👆 Clique em qualquer elemento da página para inspecioná-lo" }) }),
                !isSelectionMode && !isEditingElement && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-3 bg-slate-50 border border-slate-200 rounded-lg", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-slate-600", children: "Ative o modo de seleção e clique em um elemento para analisar seu grid de forma isolada." }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-slate-500", children: "🔧 Ativa modo de seleção para manipular elementos específicos" })
              ] }) })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(AccordionItem, { value: "advanced-baseline", className: "border-b border-slate-100", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(AccordionTrigger, { className: "px-4 py-2.5 hover:bg-violet-50/50 text-xs font-semibold", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowUpDown, { size: 14, className: "text-violet-600" }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(AccordionContent, { className: "px-4 pb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-slate-500", children: "🔧 Grid de linhas horizontais para alinhamento vertical" })
              ] }) })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(AccordionItem, { value: "advanced-density", className: "border-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(AccordionTrigger, { className: "px-4 py-2.5 hover:bg-emerald-50/50 text-xs font-semibold", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Layers, { size: 14, className: "text-emerald-600" }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(AccordionContent, { className: "px-4 pb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(ToggleGroup, { type: "single", value: densityMode, onValueChange: (v2) => v2 && setDensityMode(v2), className: "grid grid-cols-3 gap-1.5", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(ToggleGroupItem, { value: "dense", className: "text-xs h-8 data-[state=on]:bg-emerald-600 data-[state=on]:text-white", children: "Dense" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-2 bg-emerald-50 rounded border border-emerald-200", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-emerald-900 font-semibold", children: "Multiplier:" }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-slate-500", children: "🔧 Aplica multiplicador global em todos os spacings" })
              ] }) })
            ] })
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsContent, { value: "alerts", className: "p-0 m-0 flex-1 overflow-y-auto", children: [
            violations.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center gap-3 p-8 text-center", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-slate-500", children: "Todos os valores estão dentro dos tokens DSS" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-1", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                  highlightedElementIndex !== null && /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
                    {
              ...
              violations.map((v2) => {
                ...
                const isActive = v2.elementIndex !== void 0 && highlightedElementIndex === v2.elementIndex;
                return /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    className: `p-2.5 rounded-lg border-2 transition-all duration-200 ${severityConfig.bg} ${isActive ? "border-red-500 shadow-md shadow-red-200/50" : severityConfig.border} ${v2.elementIndex !== void 0 ? "cursor-pointer hover:shadow-sm" : ""}`,
                    onClick: () => {
                      if (v2.elementIndex !== void 0) {
                        setHighlightedElementIndex(isActive ? null : v2.elementIndex);
                      }
                    },
                    children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-2", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `mt-0.5 text-[9px] font-bold uppercase px-1.5 py-0.5 rounded text-white flex-shrink-0 ${severityConfig.badge}`, children: v2.severity }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: `text-xs font-semibold ${severityConfig.text} leading-snug`, children: v2.message }),
                        v2.affectedProperty && /* @__PURE__ */ jsxRuntimeExports.jsxs("code", { className: "text-[10px] text-slate-500 mt-0.5 block truncate", children: [
                          v2.affectedProperty,
                          v2.affectedValue !== void 0 ? `: ${v2.affectedValue}px` : ""
                        ] }),
                        v2.elementIndex !== void 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[10px] text-slate-400 mt-1 flex items-center gap-1", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-slate-400 pt-1 text-center", children: "Tokens DSS válidos: 0, 4, 8, 12, 16, 20, 24, 32, 40, 48, 56, 64px" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `px-3 py-2 border-t flex items-center gap-1.5 text-[10px] font-medium ${mcpConnected ? "border-emerald-100 bg-emerald-50 text-emerald-700" : "border-slate-100 bg-slate-50 text-slate-400"}`, children: [
              mcpConnected ? /* @__PURE__ */ jsxRuntimeExports.jsx(Wifi, { size: 10 }) : /* @__PURE__ */ jsxRuntimeExports.jsx(WifiOff, { size: 10 }),
              mcpConnected ? "Validação via MCP Server" : "Validação local (MCP offline)"
            ] })
          ] })
        ] }),
        showGrid && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-slate-200 p-3 bg-gradient-to-br from-slate-50 to-blue-50 flex-shrink-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs font-bold text-slate-700 mb-2 flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-2 h-2 bg-blue-600 rounded-full" }),
            "Color Legend"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 flex-wrap", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-3 h-3 bg-rose-200/40 border-2 border-rose-400 rounded" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-slate-700 font-medium", children: "Columns" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-3 h-3 border-2 border-dashed border-green-500 rounded" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-slate-700 font-medium", children: "Padding" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-3 h-3 border-2 border-dashed border-orange-500 rounded" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-slate-700 font-medium", children: "Margin" })
            ] })
          ] })
        ] })
      ]
...
function GridOverlay({
  ...
  const [overlayOpacity, setOverlayOpacity] = reactExports.useState(1);
  const [showColumns, setShowColumns] = reactExports.useState(true);
  const [showGapsX, setShowGapsX] = reactExports.useState(true);
  const [showGapsY, setShowGapsY] = reactExports.useState(true);
  const [showPaddingX, setShowPaddingX] = reactExports.useState(true);
  const [showPaddingY, setShowPaddingY] = reactExports.useState(true);
  const [showMarginX, setShowMarginX] = reactExports.useState(true);
  const [showMarginY, setShowMarginY] = reactExports.useState(true);
  const [containerMaxWidth, setContainerMaxWidth] = reactExports.useState("1440px");
  const [autoColumnWidth, setAutoColumnWidth] = reactExports.useState(true);
  const [contentBounds, setContentBounds] = reactExports.useState(null);
  const [layoutBounds, setLayoutBounds] = reactExports.useState(null);
  const [componentRows, setComponentRows] = reactExports.useState([]);
  reactExports.useEffect(() => {
    var _a;
    const resolveTarget = () => {
  ...
  const renderColumnarGrid = () => {
    ...
    const calculateFixedColumnWidth = () => {
      ...
      const w2 = Math.floor(available / columns);
      return w2 > 0 ? `${w2}px` : "100px";
    };
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: outerStyle, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: columnAreaStyle, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          children: Array.from({ length: columns }).map((_, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              className: "relative h-full",
              style: { zIndex: 15, pointerEvents: "none" },
              children: [
                showColumns && /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    children: showAnnotations && /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                      {
                ...
                showPaddingX && /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    children: showAnnotations && i === 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "div",
                      {
      ...
      showMarginX && colBounds && margin > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            style: {
      ...
      showMarginY && marginY > 0 && (() => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { position: "absolute", ...hPos, top: lbTop, height: marginY, zIndex: 60, pointerEvents: "none", borderBottom: `2px dashed rgba(249,115,22,${0.8 * overlayOpacity})`, backgroundColor: `rgba(253,186,116,${0.12 * overlayOpacity})` }, children: showAnnotations && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { position: "absolute", left: "50%", top: "50%", transform: "translate(-50%,-50%)", fontSize: 11, fontFamily: "monospace", fontWeight: 600, background: `rgba(255,255,255,${0.9 * overlayOpacity})`, color: `rgba(194,65,12,${overlayOpacity})`, padding: "2px 6px", borderRadius: 4, pointerEvents: "none" }, children: [
            marginY,
            "px margin Y"
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { position: "absolute", ...hPos, top: lbTop + lbHeight - marginY, height: marginY, zIndex: 60, pointerEvents: "none", borderTop: `2px dashed rgba(249,115,22,${0.8 * overlayOpacity})`, backgroundColor: `rgba(253,186,116,${0.12 * overlayOpacity})` } })
        ] });
      })(),
          ...
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                children: showAnnotations && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { position: "absolute", top: 4, right: 8, fontSize: 11, fontFamily: "monospace", fontWeight: 700, background: `rgba(255,255,255,${0.8 * overlayOpacity})`, color: `rgba(190,18,60,${overlayOpacity})`, padding: "2px 5px", borderRadius: 3, zIndex: 10, pointerEvents: "none" }, children: [
                  "Row ",
                  i + 1
                ] })
              }
      ...
      showPaddingY && paddingY > 0 && componentRows.map((row, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { position: "absolute", inset: `${paddingY}px 0`, pointerEvents: "none", borderTop: `2px dashed rgba(34,197,94,${0.9 * overlayOpacity})`, borderBottom: `2px dashed rgba(34,197,94,${0.9 * overlayOpacity})` }, children: showAnnotations && i === 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { position: "absolute", left: 8, top: "50%", transform: "translateY(-50%)", fontSize: 11, fontFamily: "monospace", fontWeight: 600, background: `rgba(255,255,255,${0.95 * overlayOpacity})`, color: `rgba(21,128,61,${overlayOpacity})`, padding: "2px 6px", borderRadius: 4, whiteSpace: "nowrap", pointerEvents: "none" }, children: [
            paddingY,
            "px padding Y"
          ] }) })
        },
      ...
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: Array.from({ length: columns * rows }).map((_, i) => showColumns && /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
      ...
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: ["2fr", "3fr", "2fr", "5fr"].map((size, i) => showColumns && /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                className: "bg-orange-200/40 border border-orange-400/60 relative transition-all duration-300",
                children: showAnnotations && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-2 left-2 text-xs font-mono text-orange-700 font-bold bg-white/80 px-1.5 py-0.5 rounded", children: size })
              },
              i
            ))
          }
...
function BaselineGridOverlay() {
  const [baselineSize, setBaselineSize] = reactExports.useState(8);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fixed inset-0 pointer-events-none z-[1] overflow-hidden", children: [
    Array.from({ length: lineCount }).map((_, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fixed bottom-16 left-4 bg-violet-600 text-white px-3 py-2 rounded-lg shadow-lg text-xs font-semibold flex items-center gap-2 z-50", style: { pointerEvents: "none" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-0.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-px bg-violet-300" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-px bg-violet-300" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-px bg-violet-300" })
      ] }),
...
function isToken(v2) {
  return DSS_SPACING_TOKENS.includes(Math.round(v2));
}
  ...
  render() {
    if (this.state.error) {
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "GridInspector — Erro de Render" }),
...
function GridOverlayBridge({ contentSelector }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(BaselineGridOverlay, {})
  ] });
}
function GridInspectorApp({ config = {}, debug = false }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsx(AppErrorBoundary, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(GridSystemProvider, { initialConfig: config, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(NestedGridProvider, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(ViolationBridge, {}),
        /* @__PURE__ */ jsxRuntimeExports.jsx(GridOverlayBridge, { contentSelector: config.contentSelector }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(FloatingGridInspector, {})
      ] }) }) })
    }
  );
}
...
function injectGridInspector(options = {}) {
  ...
  currentRoot.render(/* @__PURE__ */ jsxRuntimeExports.jsx(GridInspectorApp, { config: initialConfig, debug }));
  if (debug) {
