...
// Componente: DssMarkupTable — DSS v2.2
//
...
// consulte: packages/core/components/base/DssMarkupTable/DssMarkupTable.md
...
const COMPONENT_META = {
  name: "DssMarkupTable",
  kebabName: "dss-markup-table",
  description: "Componente DssMarkupTable do Design System Sansys (DSS v2.2). Fase 2 — Tabela de Exibição Semântica.",
  status: "sealed",
  seal: "Pendente",
  phase: 2,
  auditDate: "N/A",
...
const DEFAULT_PROPS = [
    { prop: "density", value: 'standard', type: typeof "standard" },
    { prop: "bordered", value: 'true', type: typeof true },
    { prop: "separator", value: 'horizontal', type: typeof "horizontal" }
]

// ─── Página ─────────────────────────────────────────────────────────────────

export default function DssMarkupTablePage() {
  return (
        ...
        <CardContent>
          ...
          <div className="mt-4 pt-4 border-t space-y-2">
            ...
            <div className="flex flex-wrap gap-2">
              <span className="font-mono text-xs bg-muted px-1 py-0.5 rounded">width: 100%</span>
            </div>
          </div>
            ...
            <ul className="mt-2 space-y-1 text-sm list-disc list-inside">
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssMarkupTable/DssMarkupTable.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssMarkupTable/DSSMARKUPTABLE_API.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  docs/Compliance/seals/DssMarkupTable/
                </code>
              </li>
            </ul>
          </CardDescription>
