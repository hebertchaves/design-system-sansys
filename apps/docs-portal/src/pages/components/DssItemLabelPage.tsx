...
// Componente: DssItemLabel — DSS v2.2
//
...
// consulte: packages/core/components/base/DssItemLabel/DssItemLabel.md
...
const COMPONENT_META = {
  name: "DssItemLabel",
  kebabName: "dss-item-label",
  description: "Componente DssItemLabel do Design System Sansys (DSS v2.2). Fase 2 — Container tipografico para itens de lista.",
  status: "sealed",
  seal: "Pendente",
  phase: 2,
  auditDate: "2026-04-20",
  goldenReference: "DssItem",
  goldenContext: "DssSeparator",
}
...
export default function DssItemLabelPage() {
  return (
            ...
            <ul className="mt-2 space-y-1 text-sm list-disc list-inside">
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssItemLabel/DssItemLabel.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssItemLabel/DSSITEMLABEL_API.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  docs/Compliance/seals/DssItemLabel/
                </code>
              </li>
            </ul>
          </CardDescription>
