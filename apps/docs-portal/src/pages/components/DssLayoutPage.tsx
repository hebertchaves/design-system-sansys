...
// consulte: packages/core/components/base/DssLayout/DssLayout.md
...
const COMPONENT_META = {
  name: "DssLayout",
  kebabName: "dss-layout",
  description: "Componente DssLayout do Design System Sansys (DSS v2.2). Fase 2 — Layout Global.",
  status: "sealed",
  seal: "Pendente",
  phase: 2,
...
export default function DssLayoutPage() {
  return (
            ...
            <ul className="mt-2 space-y-1 text-sm list-disc list-inside">
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssLayout/DssLayout.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssLayout/DSSLAYOUT_API.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  docs/Compliance/seals/DssLayout/
                </code>
              </li>
            </ul>
          </CardDescription>
