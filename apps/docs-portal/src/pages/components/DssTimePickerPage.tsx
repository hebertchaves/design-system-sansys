...
// Componente: DssTimePicker — DSS v2.2
//
...
// consulte: packages/core/components/base/DssTimePicker/DssTimePicker.md
...
const COMPONENT_META = {
  name: "DssTimePicker",
  kebabName: "dss-time-picker",
  description: "Componente DssTimePicker do Design System Sansys (DSS).",
  status: "Em revisão",
  seal: "Pendente",
  phase: "?",
  auditDate: "N/A",
...
export default function DssTimePickerPage() {
  return (
            ...
            <ul className="mt-2 space-y-1 text-sm list-disc list-inside">
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssTimePicker/DssTimePicker.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssTimePicker/DSSTIMEPICKER_API.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  docs/Compliance/seals/DssTimePicker/
                </code>
              </li>
            </ul>
          </CardDescription>
