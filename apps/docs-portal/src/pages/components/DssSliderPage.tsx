...
// Componente: DssSlider — DSS v2.2.0
//
...
// consulte: packages/core/components/base/DssSlider/DssSlider.md
...
const COMPONENT_META = {
  name: "DssSlider",
  kebabName: "dss-slider",
  description: "Componente DssSlider do Design System Sansys (DSS v2.2.0). Fase 1 — Action Control interativo — campo de intervalo numérico.",
  status: "conformant",
  seal: "DSS v2.2",
  phase: 1,
  auditDate: "2026-03-20",
  goldenReference: "DssToggle",
...
const DEFAULT_PROPS = [
    { prop: "min", value: '0', type: typeof 0 },
    { prop: "max", value: '100', type: typeof 100 },
    { prop: "modelValue", value: '50', type: typeof 50 }
]

// ─── Página ─────────────────────────────────────────────────────────────────

export default function DssSliderPage() {
  return (
            ...
            <ul className="mt-2 space-y-1 text-sm list-disc list-inside">
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssSlider/DssSlider.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssSlider/DSSSLIDER_API.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  docs/Compliance/seals/DssSlider/
                </code>
              </li>
            </ul>
          </CardDescription>
