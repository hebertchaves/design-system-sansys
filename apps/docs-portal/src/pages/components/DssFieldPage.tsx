...
// consulte: packages/core/components/base/DssField/DssField.md
...
const COMPONENT_META = {
  name: "DssField",
  kebabName: "dss-field",
  description: "Componente DssField do Design System Sansys (DSS v2.2). Fase 2 — Wrapper estrutural de campo de formulário (chrome: label, borda, hint, error).",
  status: "sealed",
  seal: "Pendente",
  phase: 2,
  auditDate: "N/A",
...
export default function DssFieldPage() {
  return (
            ...
            <ul className="mt-2 space-y-1 text-sm list-disc list-inside">
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssField/DssField.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssField/DSSFIELD_API.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  docs/Compliance/seals/DssField/
                </code>
              </li>
            </ul>
          </CardDescription>
