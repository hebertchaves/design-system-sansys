...
// Componente: DssLinearProgress — DSS v2.2
//
...
// consulte: packages/core/components/base/DssLinearProgress/DssLinearProgress.md
...
const COMPONENT_META = {
  ...
  kebabName: "dss-linear-progress",
  description: "Componente DssLinearProgress do Design System Sansys (DSS v2.2). Fase 2 — Componente DSS.",
  status: "in-progress",
  seal: "Pendente",
  phase: 2,
  auditDate: "N/A",
  goldenReference: "DssBadge",
  goldenContext: "DssSpinner",
}

const TOKENS_USED = [
    { token: "--dss-surface-muted", description: "Token DSS" },
    { token: "--dss-radius-full", description: "Token DSS" },
    { token: "--dss-opacity-disabled", description: "Token DSS" },
    { token: "--dss-duration-250", description: "Token DSS" },
    { token: "--dss-easing-standard", description: "Token DSS" },
    { token: "--dss-spacing-1", description: "Token DSS" },
    { token: "--dss-spacing-2", description: "Token DSS" },
    { token: "--dss-spacing-3", description: "Token DSS" },
    { token: "--dss-spacing-4", description: "Token DSS" },
    { token: "--dss-spacing-6", description: "Token DSS" },
    { token: "--dss-action-primary", description: "Token DSS" },
    { token: "--dss-action-secondary", description: "Token DSS" },
    { token: "--dss-feedback-error", description: "Token DSS" },
    { token: "--dss-feedback-success", description: "Token DSS" },
    { token: "--dss-feedback-warning", description: "Token DSS" },
    { token: "--dss-feedback-info", description: "Token DSS" },
    { token: "--dss-hub-600", description: "Token DSS" },
    { token: "--dss-hub-500", description: "Token DSS" },
    { token: "--dss-water-500", description: "Token DSS" },
    { token: "--dss-water-400", description: "Token DSS" }
]

const DEFAULT_PROPS = [
    { prop: "value", value: '0.7', type: typeof 0.7 },
    { prop: "color", value: 'primary', type: typeof "primary" },
    { prop: "size", value: 'md', type: typeof "md" }
]

// ─── Página ─────────────────────────────────────────────────────────────────

export default function DssLinearProgressPage() {
  return (
        ...
        <CardContent>
          ...
          <div className="mt-4 pt-4 border-t space-y-2">
            ...
            <div className="flex flex-wrap gap-2">
              <span className="font-mono text-xs bg-muted px-1 py-0.5 rounded">minHeight: 4px</span>
            <span className="font-mono text-xs bg-muted px-1 py-0.5 rounded">minWidth: 200px</span>
            </div>
          </div>
            ...
            <ul className="mt-2 space-y-1 text-sm list-disc list-inside">
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssLinearProgress/DssLinearProgress.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssLinearProgress/DSSLINEARPROGRESS_API.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  docs/Compliance/seals/DssLinearProgress/
                </code>
              </li>
            </ul>
          </CardDescription>
