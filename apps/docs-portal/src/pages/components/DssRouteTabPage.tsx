...
// Componente: DssRouteTab — DSS v2.2
//
...
// consulte: packages/core/components/base/DssRouteTab/DssRouteTab.md
...
const COMPONENT_META = {
  name: "DssRouteTab",
  kebabName: "dss-route-tab",
  description: "Componente DssRouteTab do Design System Sansys (DSS v2.2). Fase 2 — Elemento interativo de navegação por abas com roteamento.",
  status: "conforme",
  seal: "DSS v2.2",
  phase: 2,
  auditDate: "2026-04-10",
  goldenReference: "DssTab",
...
const DEFAULT_PROPS = [
    { prop: "label", value: 'Início', type: typeof "Início" },
    { prop: "to", value: '/', type: typeof "/" }
]

// ─── Página ─────────────────────────────────────────────────────────────────

export default function DssRouteTabPage() {
  return (
            ...
            <ul className="mt-2 space-y-1 text-sm list-disc list-inside">
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssRouteTab/DssRouteTab.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssRouteTab/DSSROUTETAB_API.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  docs/Compliance/seals/DssRouteTab/
                </code>
              </li>
            </ul>
          </CardDescription>
