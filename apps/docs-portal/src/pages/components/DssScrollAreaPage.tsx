...
// Componente: DssScrollArea — DSS v2.2
//
...
// consulte: packages/core/components/base/DssScrollArea/DssScrollArea.md
...
const COMPONENT_META = {
  name: "DssScrollArea",
  kebabName: "dss-scroll-area",
  description: "Componente DssScrollArea do Design System Sansys (DSS v2.2). Fase 2 — Componente DSS.",
  status: "conformant",
  seal: "Pendente",
  phase: 2,
  auditDate: "N/A",
  goldenReference: "DssBadge",
  goldenContext: "DssVirtualScroll",
}
...
const DEFAULT_PROPS = [
    { prop: "visible", value: 'auto', type: typeof "auto" },
    { prop: "horizontal", value: 'false', type: typeof false }
]

// ─── Página ─────────────────────────────────────────────────────────────────

export default function DssScrollAreaPage() {
  return (
            ...
            <ul className="mt-2 space-y-1 text-sm list-disc list-inside">
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssScrollArea/DssScrollArea.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssScrollArea/DSSSCROLLAREA_API.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  docs/Compliance/seals/DssScrollArea/
                </code>
              </li>
            </ul>
          </CardDescription>
