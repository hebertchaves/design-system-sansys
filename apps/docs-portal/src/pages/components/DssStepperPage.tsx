...
// Componente: DssStepper — DSS v2.2
//
...
// consulte: packages/core/components/base/DssStepper/DssStepper.md
...
const COMPONENT_META = {
  name: "DssStepper",
  kebabName: "dss-stepper",
  description: "Componente DssStepper do Design System Sansys (DSS v2.2). Fase 2 — Container de Navegação — Stepper/Wizard.",
  status: "sealed",
  seal: "Pendente",
  phase: 2,
  auditDate: "2026-04-20",
  goldenReference: "DssTabs",
  goldenContext: "DssStep",
}
...
export default function DssStepperPage() {
  return (
            ...
            <ul className="mt-2 space-y-1 text-sm list-disc list-inside">
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssStepper/DssStepper.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssStepper/DSSSTEPPER_API.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  docs/Compliance/seals/DssStepper/
                </code>
              </li>
            </ul>
          </CardDescription>
