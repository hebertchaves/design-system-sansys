...
// Componente: DssVirtualScroll — DSS v2.2
//
...
// consulte: packages/core/components/base/DssVirtualScroll/DssVirtualScroll.md
...
const COMPONENT_META = {
  ...
  kebabName: "dss-virtual-scroll",
  description: "Componente DssVirtualScroll do Design System Sansys (DSS v2.2). Fase 2 — Componente DSS.",
  status: "sealed",
  seal: "Pendente",
  phase: 2,
  auditDate: "N/A",
...
const TOKENS_USED = [
    ...
    { token: "--dss-spacing-px", description: "Token DSS" },
    ...
    { token: "--dss-duration-500", description: "Token DSS" },
...
const DEFAULT_PROPS = [
    { prop: "items", value: '[Array de itens]', type: typeof "[Array de itens]" },
    { prop: "itemSize", value: '48', type: typeof 48 },
    { prop: "type", value: 'list', type: typeof "list" }
]

// ─── Página ─────────────────────────────────────────────────────────────────

export default function DssVirtualScrollPage() {
  return (
            ...
            <ul className="mt-2 space-y-1 text-sm list-disc list-inside">
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssVirtualScroll/DssVirtualScroll.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssVirtualScroll/DSSVIRTUALSCROLL_API.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  docs/Compliance/seals/DssVirtualScroll/
                </code>
              </li>
            </ul>
          </CardDescription>
