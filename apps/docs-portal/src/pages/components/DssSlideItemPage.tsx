...
// Componente: DssSlideItem — DSS v2.2
//
...
// consulte: packages/core/components/base/DssSlideItem/DssSlideItem.md
...
const COMPONENT_META = {
  name: "DssSlideItem",
  kebabName: "dss-slide-item",
  description: "Componente DssSlideItem do Design System Sansys (DSS v2.2). Fase 2 — Componente DSS.",
  status: "in-progress",
  seal: "Pendente",
  phase: 2,
  auditDate: "N/A",
  goldenReference: "DssBadge",
  goldenContext: "DssPullToRefresh",
}
...
export default function DssSlideItemPage() {
  return (
            ...
            <ul className="mt-2 space-y-1 text-sm list-disc list-inside">
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssSlideItem/DssSlideItem.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssSlideItem/DSSSLIDEITEM_API.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  docs/Compliance/seals/DssSlideItem/
                </code>
              </li>
            </ul>
          </CardDescription>
