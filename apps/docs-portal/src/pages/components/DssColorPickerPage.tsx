...
// Componente: DssColorPicker — DSS v2.2
//
...
// consulte: packages/core/components/base/DssColorPicker/DssColorPicker.md
...
const COMPONENT_META = {
  name: "DssColorPicker",
  kebabName: "dss-color-picker",
  description: "Componente DssColorPicker do Design System Sansys (DSS).",
  status: "Em revisão",
  seal: "Pendente",
  phase: "?",
  auditDate: "N/A",
...
export default function DssColorPickerPage() {
  return (
            ...
            <ul className="mt-2 space-y-1 text-sm list-disc list-inside">
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssColorPicker/DssColorPicker.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssColorPicker/DSSCOLORPICKER_API.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  docs/Compliance/seals/DssColorPicker/
                </code>
              </li>
            </ul>
          </CardDescription>
