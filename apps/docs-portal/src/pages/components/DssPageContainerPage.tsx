...
// Componente: DssPageContainer — DSS v2.2
//
...
// consulte: packages/core/components/base/DssPageContainer/DssPageContainer.md
...
const COMPONENT_META = {
  ...
  kebabName: "dss-page-container",
  description: "Componente DssPageContainer do Design System Sansys (DSS v2.2). Fase 2 — Layout Global — Container de página com offset automático.",
  status: "sealed",
  seal: "Pendente",
  phase: 2,
  auditDate: "2026-04-22",
  goldenReference: "DssBadge",
  goldenContext: "DssLayout",
}
...
export default function DssPageContainerPage() {
  return (
            ...
            <ul className="mt-2 space-y-1 text-sm list-disc list-inside">
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssPageContainer/DssPageContainer.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssPageContainer/DSSPAGECONTAINER_API.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  docs/Compliance/seals/DssPageContainer/
                </code>
              </li>
            </ul>
          </CardDescription>
