...
// Componente: DssExpansionItem — DSS v2.2
//
...
// consulte: packages/core/components/base/DssExpansionItem/DssExpansionItem.md
...
const COMPONENT_META = {
  ...
  kebabName: "dss-expansion-item",
  description: "Componente DssExpansionItem do Design System Sansys (DSS v2.2). Fase 2 — Componente DSS.",
  status: "sealed",
  seal: "Pendente",
  phase: 2,
  auditDate: "N/A",
  goldenReference: "DssChip",
  goldenContext: "DssItem",
}

const TOKENS_USED = [
    { token: "--dss-font-family-sans", description: "Token DSS" },
    { token: "--dss-font-size-md", description: "Token DSS" },
    { token: "--dss-font-weight-normal", description: "Token DSS" },
    { token: "--dss-line-height-normal", description: "Token DSS" },
    { token: "--dss-text-body", description: "Token DSS" },
    { token: "--dss-text-subtle", description: "Token DSS" },
    { token: "--dss-spacing-1_5", description: "Token DSS" },
    ...
    { token: "--dss-surface-hover", description: "Token DSS" },
    { token: "--dss-surface-active", description: "Token DSS" },
    { token: "--dss-surface-subtle", description: "Token DSS" },
    { token: "--dss-surface-muted", description: "Token DSS" },
    { token: "--dss-focus-ring", description: "Token DSS" },
    { token: "--dss-duration-150", description: "Token DSS" },
    ...
    { token: "--dss-touch-target-md", description: "Token DSS" }
]

const DEFAULT_PROPS = [
    { prop: "label", value: 'Título', type: typeof "Título" },
    { prop: "icon", value: 'expand_more', type: typeof "expand_more" }
]

// ─── Página ─────────────────────────────────────────────────────────────────

export default function DssExpansionItemPage() {
  return (
            ...
            <ul className="mt-2 space-y-1 text-sm list-disc list-inside">
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssExpansionItem/DssExpansionItem.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssExpansionItem/DSSEXPANSIONITEM_API.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  docs/Compliance/seals/DssExpansionItem/
                </code>
              </li>
            </ul>
          </CardDescription>
