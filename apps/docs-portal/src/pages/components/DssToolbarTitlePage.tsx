...
// Componente: DssToolbarTitle — DSS v2.2
//
...
// consulte: packages/core/components/base/DssToolbarTitle/DssToolbarTitle.md
...
const COMPONENT_META = {
  ...
  kebabName: "dss-toolbar-title",
  description: "Componente DssToolbarTitle do Design System Sansys (DSS v2.2). Fase 2 — Container tipográfico para barra de ferramentas.",
  status: "sealed",
  seal: "Pendente",
  phase: 2,
  auditDate: "2026-04-21",
  goldenReference: "DssBadge",
  goldenContext: "DssItemLabel",
}
...
export default function DssToolbarTitlePage() {
  return (
            ...
            <ul className="mt-2 space-y-1 text-sm list-disc list-inside">
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssToolbarTitle/DssToolbarTitle.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssToolbarTitle/DSSTOOLBARTITLE_API.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  docs/Compliance/seals/DssToolbarTitle/
                </code>
              </li>
            </ul>
          </CardDescription>
