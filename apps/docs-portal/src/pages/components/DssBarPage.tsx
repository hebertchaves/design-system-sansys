...
// consulte: packages/core/components/base/DssBar/DssBar.md
...
const COMPONENT_META = {
  name: "DssBar",
  kebabName: "dss-bar",
  description: "Componente DssBar do Design System Sansys (DSS v2.2). Fase 2 — Componente DSS.",
  status: "conformant",
  seal: "Pendente",
  phase: 2,
  auditDate: "N/A",
  goldenReference: "DssBadge",
  goldenContext: "DssToolbar",
}
...
const TOKENS_USED = [
    ...
    { token: "--dss-compact-control-height-sm", description: "Token DSS" },
    { token: "--dss-padding-4", description: "Token DSS" },
    { token: "--dss-padding-2", description: "Token DSS" },
    { token: "--dss-gap-2", description: "Token DSS" },
...
export default function DssBarPage() {
  return (
            ...
            <ul className="mt-2 space-y-1 text-sm list-disc list-inside">
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssBar/DssBar.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssBar/DSSBAR_API.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  docs/Compliance/seals/DssBar/
                </code>
              </li>
            </ul>
          </CardDescription>
