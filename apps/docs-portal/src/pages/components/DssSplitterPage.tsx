...
// Componente: DssSplitter — DSS v2.2
//
...
// consulte: packages/core/components/base/DssSplitter/DssSplitter.md
...
const COMPONENT_META = {
  name: "DssSplitter",
  kebabName: "dss-splitter",
  description: "Componente DssSplitter do Design System Sansys (DSS v2.2). Fase 2 — Componente DSS.",
  status: "in-progress",
  seal: "Pendente",
  phase: 2,
  auditDate: "N/A",
  goldenReference: "DssChip",
  goldenContext: "DssSlider",
}

const TOKENS_USED = [
    { token: "--dss-gray-200", description: "Token DSS" },
    { token: "--dss-gray-400", description: "Token DSS" },
    { token: "--dss-gray-500", description: "Token DSS" },
    { token: "--dss-gray-600", description: "Token DSS" },
    { token: "--dss-gray-700", description: "Token DSS" },
    { token: "--dss-gray-800", description: "Token DSS" },
    { token: "--dss-gray-900", description: "Token DSS" },
    { token: "--dss-duration-250", description: "Token DSS" },
    { token: "--dss-easing-ease-out", description: "Token DSS" },
    { token: "--dss-touch-target-md", description: "Token DSS" },
    { token: "--dss-opacity-disabled", description: "Token DSS" },
    { token: "--dss-focus-shadow-primary", description: "Token DSS" },
    { token: "--dss-action-hub", description: "Token DSS" },
    { token: "--dss-action-water", description: "Token DSS" },
    { token: "--dss-action-waste", description: "Token DSS" }
]

const DEFAULT_PROPS = [
    { prop: "modelValue", value: '50', type: typeof 50 },
    { prop: "orientation", value: 'horizontal', type: typeof "horizontal" }
]

// ─── Página ─────────────────────────────────────────────────────────────────

export default function DssSplitterPage() {
  return (
        ...
        <CardContent>
          ...
          <div className="mt-4 pt-4 border-t space-y-2">
            ...
            <div className="flex flex-wrap gap-2">
              <span className="font-mono text-xs bg-muted px-1 py-0.5 rounded">minHeight: 200px</span>
            </div>
          </div>
            ...
            <ul className="mt-2 space-y-1 text-sm list-disc list-inside">
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssSplitter/DssSplitter.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssSplitter/DSSSPLITTER_API.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  docs/Compliance/seals/DssSplitter/
                </code>
              </li>
            </ul>
          </CardDescription>
