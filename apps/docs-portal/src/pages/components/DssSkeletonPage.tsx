...
// Componente: DssSkeleton — DSS v2.2
//
...
// consulte: packages/core/components/base/DssSkeleton/DssSkeleton.md
...
const COMPONENT_META = {
  name: "DssSkeleton",
  kebabName: "dss-skeleton",
  description: "Componente DssSkeleton do Design System Sansys (DSS v2.2). Fase 2 — Placeholder de carregamento (skeleton screen).",
  status: "granted",
  seal: "DSS v2.2",
  phase: 2,
  auditDate: "2026-05-18",
  goldenReference: "DssBadge",
  goldenContext: "DssInnerLoading",
}
...
const DEFAULT_PROPS = [
    { prop: "type", value: 'text', type: typeof "text" }
]

// ─── Página ─────────────────────────────────────────────────────────────────

export default function DssSkeletonPage() {
  return (
        ...
        <CardContent>
          ...
          <div className="mt-4 pt-4 border-t space-y-2">
            ...
            <div className="flex flex-wrap gap-2">
              <span className="font-mono text-xs bg-muted px-1 py-0.5 rounded">minHeight: 24px</span>
            ...
            <ul className="mt-2 space-y-1 text-sm list-disc list-inside">
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssSkeleton/DssSkeleton.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssSkeleton/DSSSKELETON_API.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  docs/Compliance/seals/DssSkeleton/
                </code>
              </li>
            </ul>
          </CardDescription>
