...
// Componente: DssTimeline — DSS v2.2
//
...
// consulte: packages/core/components/base/DssTimeline/DssTimeline.md
...
const COMPONENT_META = {
  name: "DssTimeline",
  kebabName: "dss-timeline",
  description: "Componente DssTimeline do Design System Sansys (DSS v2.2). Fase 2 — Componente DSS.",
  status: "conformant",
  seal: "Pendente",
  phase: 2,
  auditDate: "N/A",
  goldenReference: "DssBadge",
  goldenContext: "DssBanner",
}

const TOKENS_USED = [
    { token: "--dss-gray-300", description: "Token DSS" },
    { token: "--dss-gray-400", description: "Token DSS" },
    { token: "--dss-gray-600", description: "Token DSS" },
    { token: "--dss-gray-700", description: "Token DSS" },
    { token: "--dss-hub-600", description: "Token DSS" },
    { token: "--dss-hub-800", description: "Token DSS" },
    { token: "--dss-water-500", description: "Token DSS" },
    { token: "--dss-water-700", description: "Token DSS" },
    { token: "--dss-waste-600", description: "Token DSS" },
    { token: "--dss-waste-800", description: "Token DSS" },
    { token: "--dss-text-body", description: "Token DSS" },
    { token: "--dss-text-subtle", description: "Token DSS" },
    { token: "--dss-text-inverse", description: "Token DSS" },
    { token: "--dss-font-family-sans", description: "Token DSS" },
    { token: "--dss-font-size-md", description: "Token DSS" },
    { token: "--dss-font-size-sm", description: "Token DSS" },
    { token: "--dss-font-weight-normal", description: "Token DSS" },
    { token: "--dss-font-weight-semibold", description: "Token DSS" },
    { token: "--dss-line-height-md", description: "Token DSS" },
    { token: "--dss-spacing-1", description: "Token DSS" }
]

const DEFAULT_PROPS = [
    { prop: "side", value: 'right', type: typeof "right" }
]

// ─── Página ─────────────────────────────────────────────────────────────────

export default function DssTimelinePage() {
  return (
            ...
            <ul className="mt-2 space-y-1 text-sm list-disc list-inside">
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssTimeline/DssTimeline.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssTimeline/DSSTIMELINE_API.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  docs/Compliance/seals/DssTimeline/
                </code>
              </li>
            </ul>
          </CardDescription>
