...
// consulte: packages/core/components/base/DssRating/DssRating.md
...
const COMPONENT_META = {
  name: "DssRating",
  kebabName: "dss-rating",
  description: "Componente DssRating do Design System Sansys (DSS v2.2). Fase 2 — Controle de avaliação por ícones (estrelas ou customizados).",
  status: "sealed",
  seal: "Pendente",
  phase: 2,
  auditDate: "N/A",
  goldenReference: "DssChip",
  goldenContext: "DssKnob",
}
...
const DEFAULT_PROPS = [
    { prop: "modelValue", value: '3', type: typeof 3 },
    { prop: "max", value: '5', type: typeof 5 }
]

// ─── Página ─────────────────────────────────────────────────────────────────

export default function DssRatingPage() {
  return (
      ...
      <Card>
        ...
        <CardContent>
          ...
          <div className="mt-4 pt-4 border-t space-y-2">
            ...
            <span className="font-mono text-xs bg-muted px-1 py-0.5 rounded">minWidth: 160px</span>
            </div>
          </div>
            ...
            <ul className="mt-2 space-y-1 text-sm list-disc list-inside">
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssRating/DssRating.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssRating/DSSRATING_API.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  docs/Compliance/seals/DssRating/
                </code>
              </li>
            </ul>
          </CardDescription>
