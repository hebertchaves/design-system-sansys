...
// Componente: DssPopupEdit — DSS v2.2
//
...
// consulte: packages/core/components/base/DssPopupEdit/DssPopupEdit.md
...
const COMPONENT_META = {
  name: "DssPopupEdit",
  kebabName: "dss-popup-edit",
  description: "Componente DssPopupEdit do Design System Sansys (DSS).",
  status: "Em revisão",
  seal: "Pendente",
  phase: "?",
  auditDate: "N/A",
...
export default function DssPopupEditPage() {
  return (
            ...
            <ul className="mt-2 space-y-1 text-sm list-disc list-inside">
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssPopupEdit/DssPopupEdit.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssPopupEdit/DSSPOPUPEDIT_API.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  docs/Compliance/seals/DssPopupEdit/
                </code>
              </li>
            </ul>
          </CardDescription>
