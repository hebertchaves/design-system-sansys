...
// Componente: DssDatePicker — DSS v2.2
//
...
// consulte: packages/core/components/base/DssDatePicker/DssDatePicker.md
...
const COMPONENT_META = {
  name: "DssDatePicker",
  kebabName: "dss-date-picker",
  description: "Componente DssDatePicker do Design System Sansys (DSS).",
  status: "Em revisão",
  seal: "Pendente",
  phase: "?",
  auditDate: "N/A",
...
export default function DssDatePickerPage() {
  return (
            ...
            <ul className="mt-2 space-y-1 text-sm list-disc list-inside">
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssDatePicker/DssDatePicker.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssDatePicker/DSSDATEPICKER_API.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  docs/Compliance/seals/DssDatePicker/
                </code>
              </li>
            </ul>
          </CardDescription>
