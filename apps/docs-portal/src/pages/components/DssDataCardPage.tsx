...
// Componente: DssDataCard — DSS v2.2
//
...
// consulte: packages/core/components/base/DssDataCard/DssDataCard.md
...
const COMPONENT_META = {
  name: "DssDataCard",
  kebabName: "dss-data-card",
  description: "Componente DssDataCard do Design System Sansys (DSS).",
  status: "Em revisão",
  seal: "Pendente",
  phase: "?",
  auditDate: "N/A",
...
export default function DssDataCardPage() {
  return (
            ...
            <ul className="mt-2 space-y-1 text-sm list-disc list-inside">
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssDataCard/DssDataCard.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssDataCard/DSSDATACARD_API.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  docs/Compliance/seals/DssDataCard/
                </code>
              </li>
            </ul>
          </CardDescription>
