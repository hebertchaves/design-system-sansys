...
// Componente: DssBottomSheet — DSS v2.2
//
...
// consulte: packages/core/components/base/DssBottomSheet/DssBottomSheet.md
...
const COMPONENT_META = {
  name: "DssBottomSheet",
  kebabName: "dss-bottom-sheet",
  description: "Componente DssBottomSheet do Design System Sansys (DSS).",
  status: "Em revisão",
  seal: "Pendente",
  phase: "?",
  auditDate: "N/A",
...
export default function DssBottomSheetPage() {
  return (
            ...
            <ul className="mt-2 space-y-1 text-sm list-disc list-inside">
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssBottomSheet/DssBottomSheet.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssBottomSheet/DSSBOTTOMSHEET_API.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  docs/Compliance/seals/DssBottomSheet/
                </code>
              </li>
            </ul>
          </CardDescription>
