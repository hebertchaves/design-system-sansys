...
// Componente: DssPopupProxy — DSS v2.2
//
...
// consulte: packages/core/components/base/DssPopupProxy/DssPopupProxy.md
...
const COMPONENT_META = {
  name: "DssPopupProxy",
  kebabName: "dss-popup-proxy",
  description: "Componente DssPopupProxy do Design System Sansys (DSS v2.2). Fase 2 — Componente DSS.",
  status: "sealed",
  seal: "DSS v2.2",
  phase: 2,
  auditDate: "2026-05-22",
  goldenReference: "DssChip",
  goldenContext: "DssMenu",
}
...
const DEFAULT_PROPS = [
    { prop: "breakpoint", value: '450', type: typeof 450 }
]

// ─── Página ─────────────────────────────────────────────────────────────────

export default function DssPopupProxyPage() {
  return (
            ...
            <ul className="mt-2 space-y-1 text-sm list-disc list-inside">
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssPopupProxy/DssPopupProxy.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssPopupProxy/DSSPOPUPPROXY_API.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  docs/Compliance/seals/DssPopupProxy/
                </code>
              </li>
            </ul>
          </CardDescription>
