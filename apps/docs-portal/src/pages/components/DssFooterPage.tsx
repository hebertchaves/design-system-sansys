...
// consulte: packages/core/components/base/DssFooter/DssFooter.md
...
const COMPONENT_META = {
  name: "DssFooter",
  kebabName: "dss-footer",
  description: "Componente DssFooter do Design System Sansys (DSS v2.2). Fase 2 — Container estrutural de layout de página — footer fixo na base.",
  status: "sealed",
  seal: "DSS v2.2",
  phase: 2,
  auditDate: "2026-04-18",
  goldenReference: "DssCard",
...
export default function DssFooterPage() {
  return (
            ...
            <ul className="mt-2 space-y-1 text-sm list-disc list-inside">
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssFooter/DssFooter.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssFooter/DSSFOOTER_API.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  docs/Compliance/seals/DssFooter/
                </code>
              </li>
            </ul>
          </CardDescription>
