...
// Componente: DssFabAction — DSS v2.2
//
...
// consulte: packages/core/components/base/DssFabAction/DssFabAction.md
...
const COMPONENT_META = {
  name: "DssFabAction",
  kebabName: "dss-fab-action",
  description: "Componente DssFabAction do Design System Sansys (DSS v2.2). Fase 2 — Componente DSS.",
  status: "conformant",
  seal: "Pendente",
  phase: 2,
  auditDate: "N/A",
  goldenReference: "DssChip",
  goldenContext: "DssFab",
}

const TOKENS_USED = [
    { token: "--dss-radius-full", description: "Token DSS" },
    { token: "--dss-elevation-1", description: "Token DSS" },
    { token: "--dss-elevation-2", description: "Token DSS" },
    { token: "--dss-duration-200", description: "Token DSS" },
    { token: "--dss-easing-standard", description: "Token DSS" },
    { token: "--dss-spacing-10", description: "Token DSS" },
    { token: "--dss-padding-4", description: "Token DSS" },
...
const DEFAULT_PROPS = [
    ...
    { prop: "icon", value: 'mail', type: typeof "mail" }
]

// ─── Página ─────────────────────────────────────────────────────────────────

export default function DssFabActionPage() {
  return (
        ...
        <CardContent>
          ...
          <div className="mt-4 pt-4 border-t space-y-2">
            ...
            <div className="flex flex-wrap gap-2">
              <span className="font-mono text-xs bg-muted px-1 py-0.5 rounded">minHeight: 40px</span>
            <span className="font-mono text-xs bg-muted px-1 py-0.5 rounded">minWidth: 40px</span>
            </div>
          </div>
            ...
            <ul className="mt-2 space-y-1 text-sm list-disc list-inside">
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssFabAction/DssFabAction.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssFabAction/DSSFABACTION_API.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  docs/Compliance/seals/DssFabAction/
                </code>
              </li>
            </ul>
          </CardDescription>
