...
// Componente: DssCircularProgress — DSS v2.2
//
...
// consulte: packages/core/components/base/DssCircularProgress/DssCircularProgress.md
...
const COMPONENT_META = {
  ...
  kebabName: "dss-circular-progress",
  description: "Componente DssCircularProgress do Design System Sansys (DSS v2.2). Fase 2 — Componente DSS.",
  status: "in-progress",
  seal: "Pendente",
  phase: 2,
  auditDate: "N/A",
  goldenReference: "DssBadge",
  goldenContext: "DssLinearProgress",
}

const TOKENS_USED = [
    { token: "--dss-surface-muted", description: "Token DSS" },
    { token: "--dss-opacity-disabled", description: "Token DSS" },
    { token: "--dss-spacing-10", description: "Token DSS" },
    { token: "--dss-spacing-12", description: "Token DSS" },
    { token: "--dss-spacing-16", description: "Token DSS" },
    { token: "--dss-spacing-20", description: "Token DSS" },
    { token: "--dss-spacing-24", description: "Token DSS" },
...
export default function DssCircularProgressPage() {
  return (
        ...
        <CardContent>
          ...
          <div className="mt-4 pt-4 border-t space-y-2">
            ...
            <div className="flex flex-wrap gap-2">
              <span className="font-mono text-xs bg-muted px-1 py-0.5 rounded">minHeight: 56px</span>
            <span className="font-mono text-xs bg-muted px-1 py-0.5 rounded">minWidth: 56px</span>
            </div>
          </div>
            ...
            <ul className="mt-2 space-y-1 text-sm list-disc list-inside">
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssCircularProgress/DssCircularProgress.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssCircularProgress/DSSCIRCULARPROGRESS_API.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  docs/Compliance/seals/DssCircularProgress/
                </code>
              </li>
            </ul>
          </CardDescription>
