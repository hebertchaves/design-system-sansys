...
// Componente: DssAjaxBar — DSS v2.2
//
...
// consulte: packages/core/components/base/DssAjaxBar/DssAjaxBar.md
...
const COMPONENT_META = {
  name: "DssAjaxBar",
  kebabName: "dss-ajax-bar",
  description: "Componente DssAjaxBar do Design System Sansys (DSS v2.2). Fase 2 — Barra de progresso global para requisições assíncronas.",
  status: "compliant",
  seal: "Pendente",
  phase: 2,
  auditDate: "N/A",
...
export default function DssAjaxBarPage() {
  return (
        ...
        <CardContent>
          ...
          <div className="mt-4 pt-4 border-t space-y-2">
            ...
            <div className="flex flex-wrap gap-2">
              <span className="font-mono text-xs bg-muted px-1 py-0.5 rounded">minHeight: 3px</span>
            </div>
          </div>
            ...
            <ul className="mt-2 space-y-1 text-sm list-disc list-inside">
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssAjaxBar/DssAjaxBar.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssAjaxBar/DSSAJAXBAR_API.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  docs/Compliance/seals/DssAjaxBar/
                </code>
              </li>
            </ul>
          </CardDescription>
