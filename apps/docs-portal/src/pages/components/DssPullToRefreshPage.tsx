...
// Componente: DssPullToRefresh — DSS v2.2
//
...
// consulte: packages/core/components/base/DssPullToRefresh/DssPullToRefresh.md
...
const COMPONENT_META = {
  name: "DssPullToRefresh",
  kebabName: "dss-pull-to-refresh",
  description: "Componente DssPullToRefresh do Design System Sansys (DSS v2.2). Fase 2 — Componente DSS.",
  status: "sealed",
  seal: "Pendente",
  phase: 2,
  auditDate: "N/A",
  goldenReference: "DssChip",
  goldenContext: "DssInfiniteScroll",
}

const TOKENS_USED = [
    { token: "--dss-action-primary", description: "Token DSS" },
    { token: "--dss-surface-default", description: "Token DSS" },
    { token: "--dss-shadow-md", description: "Token DSS" },
    { token: "--dss-padding-1", description: "Token DSS" },
    { token: "--dss-padding-2", description: "Token DSS" },
    { token: "--dss-padding-3", description: "Token DSS" },
    { token: "--dss-icon-size-sm", description: "Token DSS" },
    { token: "--dss-icon-size-md", description: "Token DSS" },
    { token: "--dss-icon-size-lg", description: "Token DSS" },
    ...
    { token: "--dss-hub-50", description: "Token DSS" },
    { token: "--dss-shadow-hub-md", description: "Token DSS" },
    { token: "--dss-water-500", description: "Token DSS" },
    { token: "--dss-water-50", description: "Token DSS" },
    { token: "--dss-shadow-water-md", description: "Token DSS" },
    { token: "--dss-waste-600", description: "Token DSS" },
    { token: "--dss-waste-50", description: "Token DSS" },
    { token: "--dss-shadow-waste-md", description: "Token DSS" }
]
...
export default function DssPullToRefreshPage() {
  return (
            ...
            <ul className="mt-2 space-y-1 text-sm list-disc list-inside">
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssPullToRefresh/DssPullToRefresh.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssPullToRefresh/DSSPULLTOREFRESH_API.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  docs/Compliance/seals/DssPullToRefresh/
                </code>
              </li>
            </ul>
          </CardDescription>
