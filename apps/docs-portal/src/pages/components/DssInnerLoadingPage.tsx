...
// Componente: DssInnerLoading — DSS v2.2
//
...
// consulte: packages/core/components/base/DssInnerLoading/DssInnerLoading.md
...
const COMPONENT_META = {
  ...
  kebabName: "dss-inner-loading",
  description: "Componente DssInnerLoading do Design System Sansys (DSS v2.2). Fase 2 — Overlay de loading para container.",
  status: "conformant",
  seal: "Pendente",
  phase: 2,
  auditDate: "N/A",
  goldenReference: "DssBadge",
  goldenContext: "DssCircularProgress",
}
...
const DEFAULT_PROPS = [
    { prop: "showing", value: 'true', type: typeof true }
]

// ─── Página ─────────────────────────────────────────────────────────────────

export default function DssInnerLoadingPage() {
  return (
            ...
            <ul className="mt-2 space-y-1 text-sm list-disc list-inside">
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssInnerLoading/DssInnerLoading.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssInnerLoading/DSSINNERLOADING_API.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  docs/Compliance/seals/DssInnerLoading/
                </code>
              </li>
            </ul>
          </CardDescription>
