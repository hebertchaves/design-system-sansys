...
// Componente: DssUploader — DSS v2.2
//
...
// consulte: packages/core/components/base/DssUploader/DssUploader.md
...
const COMPONENT_META = {
  name: "DssUploader",
  kebabName: "dss-uploader",
  description: "Componente DssUploader do Design System Sansys (DSS).",
  status: "Em revisão",
  seal: "Pendente",
  phase: "?",
  auditDate: "N/A",
...
export default function DssUploaderPage() {
  return (
            ...
            <ul className="mt-2 space-y-1 text-sm list-disc list-inside">
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssUploader/DssUploader.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssUploader/DSSUPLOADER_API.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  docs/Compliance/seals/DssUploader/
                </code>
              </li>
            </ul>
          </CardDescription>
