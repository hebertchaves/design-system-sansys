...
// consulte: packages/core/components/base/DssTab/DssTab.md
...
const COMPONENT_META = {
  name: "DssTab",
  kebabName: "dss-tab",
  description: "Componente DssTab do Design System Sansys (DSS v2.2). Fase 2 — Elemento interativo de navegacao por abas.",
  status: "Aprovado",
  seal: "DSS v2.2",
  phase: 2,
...
const DEFAULT_PROPS = [
    { prop: "label", value: 'Aba', type: typeof "Aba" }
]

// ─── Página ─────────────────────────────────────────────────────────────────

export default function DssTabPage() {
  return (
            ...
            <ul className="mt-2 space-y-1 text-sm list-disc list-inside">
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssTab/DssTab.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssTab/DSSTAB_API.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  docs/Compliance/seals/DssTab/
                </code>
              </li>
            </ul>
          </CardDescription>
