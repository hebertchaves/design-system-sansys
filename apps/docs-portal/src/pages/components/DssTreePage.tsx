...
// consulte: packages/core/components/base/DssTree/DssTree.md
...
const COMPONENT_META = {
  name: "DssTree",
  kebabName: "dss-tree",
  description: "Componente DssTree do Design System Sansys (DSS v2.2). Fase 2 — Componente DSS.",
  status: "sealed",
  seal: "Pendente",
  phase: 2,
  auditDate: "2026-05-22",
  goldenReference: "DssChip",
  goldenContext: "DssExpansionItem",
}
...
const TOKENS_USED = [
    ...
    { token: "--dss-gray-50", description: "Token DSS" },
    { token: "--dss-gray-100", description: "Token DSS" },
    { token: "--dss-gray-200", description: "Token DSS" },
    { token: "--dss-gray-700", description: "Token DSS" },
    { token: "--dss-gray-800", description: "Token DSS" },
    { token: "--dss-radius-sm", description: "Token DSS" },
...
const DEFAULT_PROPS = [
    { prop: "nodeKey", value: 'id', type: typeof "id" },
    { prop: "labelKey", value: 'label', type: typeof "label" }
]

// ─── Página ─────────────────────────────────────────────────────────────────

export default function DssTreePage() {
  return (
            ...
            <ul className="mt-2 space-y-1 text-sm list-disc list-inside">
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssTree/DssTree.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssTree/DSSTREE_API.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  docs/Compliance/seals/DssTree/
                </code>
              </li>
            </ul>
          </CardDescription>
