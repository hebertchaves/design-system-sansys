...
// Componente: DssChatMessage — DSS v2.2
//
...
// consulte: packages/core/components/base/DssChatMessage/DssChatMessage.md
...
const COMPONENT_META = {
  name: "DssChatMessage",
  kebabName: "dss-chat-message",
  description: "Componente DssChatMessage do Design System Sansys (DSS).",
  status: "Em revisão",
  seal: "Pendente",
  phase: "?",
  auditDate: "N/A",
...
export default function DssChatMessagePage() {
  return (
            ...
            <ul className="mt-2 space-y-1 text-sm list-disc list-inside">
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssChatMessage/DssChatMessage.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssChatMessage/DSSCHATMESSAGE_API.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  docs/Compliance/seals/DssChatMessage/
                </code>
              </li>
            </ul>
          </CardDescription>
