...
// Componente: DssSeparator — DSS v2.2
//
...
// consulte: packages/core/components/base/DssSeparator/DssSeparator.md
...
const COMPONENT_META = {
  name: "DssSeparator",
  kebabName: "dss-separator",
  description: "Componente DssSeparator do Design System Sansys (DSS v2.2). Fase 1 — Decorativo / Estrutural nao interativo.",
  status: "conformant",
  seal: "DSS v2.2",
  phase: 1,
...
export default function DssSeparatorPage() {
  return (
        ...
        <CardContent>
          ...
          <div className="mt-4 pt-4 border-t space-y-2">
            ...
            <div className="flex flex-wrap gap-2">
              <span className="font-mono text-xs bg-muted px-1 py-0.5 rounded">minHeight: 1px</span>
            </div>
          </div>
            ...
            <ul className="mt-2 space-y-1 text-sm list-disc list-inside">
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssSeparator/DssSeparator.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssSeparator/DSSSEPARATOR_API.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  docs/Compliance/seals/DssSeparator/
                </code>
              </li>
            </ul>
          </CardDescription>
