...
// Componente: DssTabPanel — DSS v2.2
//
...
// consulte: packages/core/components/base/DssTabPanel/DssTabPanel.md
...
const COMPONENT_META = {
  name: "DssTabPanel",
  kebabName: "dss-tab-panel",
  description: "Componente DssTabPanel do Design System Sansys (DSS v2.2). Fase 1 — Container de Conteúdo (Tab Panel).",
  status: "conforme",
  seal: "DSS v2.2",
  phase: 1,
...
export default function DssTabPanelPage() {
  return (
            ...
            <ul className="mt-2 space-y-1 text-sm list-disc list-inside">
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssTabPanel/DssTabPanel.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssTabPanel/DSSTABPANEL_API.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  docs/Compliance/seals/DssTabPanel/
                </code>
              </li>
            </ul>
          </CardDescription>
