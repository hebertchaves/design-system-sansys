...
// consulte: packages/core/components/base/DssBanner/DssBanner.md
...
const COMPONENT_META = {
  name: "DssBanner",
  kebabName: "dss-banner",
  description: "Componente DssBanner do Design System Sansys (DSS v2.2). Fase 2 — Componente DSS.",
  status: "conformant",
  seal: "Pendente",
  phase: 2,
  auditDate: "N/A",
  goldenReference: "DssBadge",
  goldenContext: "DssBadge",
}
...
const TOKENS_USED = [
    ...
    { token: "--dss-line-height-md", description: "Token DSS" },
    { token: "--dss-padding-4", description: "Token DSS" },
    { token: "--dss-padding-2", description: "Token DSS" },
    { token: "--dss-gap-3", description: "Token DSS" },
    { token: "--dss-spacing-0_5", description: "Token DSS" },
    { token: "--dss-border-width-heavy", description: "Token DSS" },
    { token: "--dss-text-body", description: "Token DSS" },
    { token: "--dss-surface-default", description: "Token DSS" },
    { token: "--dss-surface-subtle", description: "Token DSS" },
    { token: "--dss-surface-brand-light", description: "Token DSS" },
    { token: "--dss-gray-300", description: "Token DSS" },
    { token: "--dss-gray-700", description: "Token DSS" },
    { token: "--dss-feedback-info", description: "Token DSS" },
    { token: "--dss-feedback-info-deep", description: "Token DSS" },
    { token: "--dss-feedback-info-surface", description: "Token DSS" },
    { token: "--dss-feedback-success", description: "Token DSS" },
    { token: "--dss-feedback-success-deep", description: "Token DSS" }
]

const DEFAULT_PROPS = [
    { prop: "variant", value: 'default', type: typeof "default" }
]

// ─── Página ─────────────────────────────────────────────────────────────────

export default function DssBannerPage() {
  return (
        ...
        <CardContent>
          ...
          <div className="mt-4 pt-4 border-t space-y-2">
            ...
            <div className="flex flex-wrap gap-2">
              <span className="font-mono text-xs bg-muted px-1 py-0.5 rounded">minHeight: 48px</span>
            </div>
          </div>
            ...
            <ul className="mt-2 space-y-1 text-sm list-disc list-inside">
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssBanner/DssBanner.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssBanner/DSSBANNER_API.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  docs/Compliance/seals/DssBanner/
                </code>
              </li>
            </ul>
          </CardDescription>
