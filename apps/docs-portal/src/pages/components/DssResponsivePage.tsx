...
// Componente: DssResponsive — DSS v2.2
//
...
// consulte: packages/core/components/base/DssResponsive/DssResponsive.md
...
const COMPONENT_META = {
  name: "DssResponsive",
  kebabName: "dss-responsive",
  description: "Componente DssResponsive do Design System Sansys (DSS v2.2). Fase 2 — Componente DSS.",
  status: "in-progress",
  seal: "Pendente",
  phase: 2,
  auditDate: "N/A",
...
const DEFAULT_PROPS = [
    { prop: "show", value: 'sm', type: typeof "sm" }
]

// ─── Página ─────────────────────────────────────────────────────────────────

export default function DssResponsivePage() {
  return (
            ...
            <ul className="mt-2 space-y-1 text-sm list-disc list-inside">
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssResponsive/DssResponsive.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssResponsive/DSSRESPONSIVE_API.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  docs/Compliance/seals/DssResponsive/
                </code>
              </li>
            </ul>
          </CardDescription>
