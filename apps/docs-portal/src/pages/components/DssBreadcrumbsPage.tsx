...
// Componente: DssBreadcrumbs — DSS v2.2
//
...
// consulte: packages/core/components/base/DssBreadcrumbs/DssBreadcrumbs.md
...
const COMPONENT_META = {
  name: "DssBreadcrumbs",
  kebabName: "dss-breadcrumbs",
  description: "Componente DssBreadcrumbs do Design System Sansys (DSS v2.2). Fase 2 — Container Orquestrador de Navegação (Breadcrumb Trail).",
  status: "conforme",
  seal: "DSS v2.2",
  phase: 2,
  auditDate: "2026-04-11",
  goldenReference: "DssBtnGroup",
...
export default function DssBreadcrumbsPage() {
  return (
        ...
        <CardContent>
          ...
          <div className="mt-4 pt-4 border-t space-y-2">
            ...
            <div className="flex flex-wrap gap-2">
              <span className="font-mono text-xs bg-muted px-1 py-0.5 rounded">minHeight: 21px</span>
            </div>
          </div>
            ...
            <ul className="mt-2 space-y-1 text-sm list-disc list-inside">
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssBreadcrumbs/DssBreadcrumbs.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssBreadcrumbs/DSSBREADCRUMBS_API.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  docs/Compliance/seals/DssBreadcrumbs/
                </code>
              </li>
            </ul>
          </CardDescription>
