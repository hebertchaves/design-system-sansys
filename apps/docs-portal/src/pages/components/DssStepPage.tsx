...
// consulte: packages/core/components/base/DssStep/DssStep.md
...
const COMPONENT_META = {
  name: "DssStep",
  kebabName: "dss-step",
  description: "Componente DssStep do Design System Sansys (DSS v2.2). Fase 2 — Elemento interativo de navegação em stepper (wizard).",
  status: "sealed",
  seal: "Pendente",
  phase: 2,
...
export default function DssStepPage() {
  return (
            ...
            <ul className="mt-2 space-y-1 text-sm list-disc list-inside">
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssStep/DssStep.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssStep/DSSSTEP_API.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  docs/Compliance/seals/DssStep/
                </code>
              </li>
            </ul>
          </CardDescription>
