...
// Componente: DssEmptyState — DSS v2.5
//
...
// consulte: packages/core/components/base/DssEmptyState/DssEmptyState.md
...
const COMPONENT_META = {
  name: "DssEmptyState",
  kebabName: "dss-empty-state",
  description: "Componente DssEmptyState do Design System Sansys (DSS v2.5). Fase 1 — Bloco de estado de dado nao interativo.",
  status: "sealed",
  seal: "DSS v2.2",
  phase: 1,
...
const DEFAULT_PROPS = [
  { prop: "icon", value: "inbox" },
  { prop: "title", value: "Nenhuma solicitacao encontrada" },
  { prop: "description", value: "Ajuste os filtros ou limpe a busca para ver todos os registros." },
  { prop: "size", value: "md" },
  { prop: "variant", value: "plain" }
]

// ─── Página ─────────────────────────────────────────────────────────────────

export default function DssEmptyStatePage() {
  return (
        ...
        <CardContent>
          ...
          <div className="mt-4 pt-4 border-t space-y-2">
            ...
            <div className="flex flex-wrap gap-2">
              <span className="font-mono text-xs bg-muted px-1 py-0.5 rounded">padding: 32px 16px</span>
              <span className="font-mono text-xs bg-muted px-1 py-0.5 rounded">gap: 12px</span>
            </div>
          </div>
        </CardContent>
      </Card>
            ...
            <ul className="mt-2 space-y-1 text-sm list-disc list-inside">
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssEmptyState/DssEmptyState.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssEmptyState/DSSEMPTYSTATE_API.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  docs/Compliance/seals/DssEmptyState/
                </code>
              </li>
            </ul>
          </CardDescription>
