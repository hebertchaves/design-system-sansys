...
// Componente: DssParallax — DSS v2.2
//
...
// consulte: packages/core/components/base/DssParallax/DssParallax.md
...
const COMPONENT_META = {
  name: "DssParallax",
  kebabName: "dss-parallax",
  description: "Componente DssParallax do Design System Sansys (DSS v2.2). Fase 2 — Componente DSS.",
  status: "in-progress",
  seal: "Pendente",
  phase: 2,
  auditDate: "N/A",
  goldenReference: "DssBadge",
  goldenContext: "DssVideo",
}
...
const DEFAULT_PROPS = [
    { prop: "src", value: '[URL da imagem]', type: typeof "[URL da imagem]" },
    { prop: "height", value: '500', type: typeof 500 },
    { prop: "speed", value: '0.5', type: typeof 0.5 }
]

// ─── Página ─────────────────────────────────────────────────────────────────

export default function DssParallaxPage() {
  return (
            ...
            <ul className="mt-2 space-y-1 text-sm list-disc list-inside">
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssParallax/DssParallax.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssParallax/DSSPARALLAX_API.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  docs/Compliance/seals/DssParallax/
                </code>
              </li>
            </ul>
          </CardDescription>
