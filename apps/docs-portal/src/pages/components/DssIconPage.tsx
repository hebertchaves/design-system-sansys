...
// consulte: packages/core/components/base/DssIcon/DssIcon.md
...
const COMPONENT_META = {
  name: "DssIcon",
  kebabName: "dss-icon",
  description: "Componente DssIcon do Design System Sansys (DSS v2.2). Fase 1 — Elemento Visual Base nao interativo.",
  status: "Aprovado",
  seal: "DSS v2.2",
  phase: 1,
...
const DEFAULT_PROPS = [
    { prop: "name", value: 'star', type: typeof "star" },
    { prop: "size", value: 'md', type: typeof "md" }
]

// ─── Página ─────────────────────────────────────────────────────────────────

export default function DssIconPage() {
  return (
      ...
      <Card>
        ...
        <CardContent>
          ...
          <div className="mt-4 pt-4 border-t space-y-2">
            ...
            <span className="font-mono text-xs bg-muted px-1 py-0.5 rounded">minWidth: 24px</span>
            </div>
          </div>
            ...
            <ul className="mt-2 space-y-1 text-sm list-disc list-inside">
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssIcon/DssIcon.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssIcon/DSSICON_API.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  docs/Compliance/seals/DssIcon/
                </code>
              </li>
            </ul>
          </CardDescription>
