...
// Componente: DssPageSticky — DSS v2.2
//
...
// consulte: packages/core/components/base/DssPageSticky/DssPageSticky.md
...
const COMPONENT_META = {
  name: "DssPageSticky",
  kebabName: "dss-page-sticky",
  description: "Componente DssPageSticky do Design System Sansys (DSS v2.2). Fase 2 — Componente DSS.",
  status: "in-progress",
  seal: "Pendente",
  phase: 2,
  auditDate: "N/A",
  goldenReference: "DssBadge",
  goldenContext: "DssHeader",
}

const TOKENS_USED = [
    { token: "--dss-z-index-sticky", description: "Token DSS" },
    { token: "--dss-elevation-2", description: "Token DSS" },
    { token: "--dss-shadow-lg", description: "Token DSS" },
...
export default function DssPageStickyPage() {
  return (
            ...
            <ul className="mt-2 space-y-1 text-sm list-disc list-inside">
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssPageSticky/DssPageSticky.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssPageSticky/DSSPAGESTICKY_API.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  docs/Compliance/seals/DssPageSticky/
                </code>
              </li>
            </ul>
          </CardDescription>
