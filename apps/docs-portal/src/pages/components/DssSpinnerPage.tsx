...
// Componente: DssSpinner — DSS v2.2.0
//
...
// consulte: packages/core/components/base/DssSpinner/DssSpinner.md
...
const COMPONENT_META = {
  name: "DssSpinner",
  kebabName: "dss-spinner",
  description: "Componente DssSpinner do Design System Sansys (DSS v2.2.0). Fase 1 — Feedback de Status — indicador de carregamento.",
  status: "conformant",
  seal: "DSS v2.2",
  phase: 1,
  auditDate: "2026-03-24",
  goldenReference: "DssBadge",
  goldenContext: "DssIcon",
}
...
const DEFAULT_PROPS = [
    { prop: "type", value: 'standard', type: typeof "standard" },
    { prop: "size", value: 'md', type: typeof "md" }
]

// ─── Página ─────────────────────────────────────────────────────────────────

export default function DssSpinnerPage() {
  return (
            ...
            <ul className="mt-2 space-y-1 text-sm list-disc list-inside">
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssSpinner/DssSpinner.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssSpinner/DSSSPINNER_API.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  docs/Compliance/seals/DssSpinner/
                </code>
              </li>
            </ul>
          </CardDescription>
