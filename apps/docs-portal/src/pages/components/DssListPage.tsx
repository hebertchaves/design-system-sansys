...
// consulte: packages/core/components/base/DssList/DssList.md
...
const COMPONENT_META = {
  name: "DssList",
  kebabName: "dss-list",
  description: "Componente DssList do Design System Sansys (DSS v2.2). Fase 2 — Container de Layout.",
  status: "conforme",
  seal: "DSS v2.2",
  phase: 2,
...
export default function DssListPage() {
  return (
            ...
            <ul className="mt-2 space-y-1 text-sm list-disc list-inside">
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssList/DssList.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssList/DSSLIST_API.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  docs/Compliance/seals/DssList/
                </code>
              </li>
            </ul>
          </CardDescription>
