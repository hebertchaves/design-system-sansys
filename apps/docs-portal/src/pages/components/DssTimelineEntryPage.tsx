...
// Componente: DssTimelineEntry — DSS v2.2
//
...
// consulte: packages/core/components/base/DssTimelineEntry/DssTimelineEntry.md
...
const COMPONENT_META = {
  name: "DssTimelineEntry",
  kebabName: "dss-timeline-entry",
  description: "Componente DssTimelineEntry do Design System Sansys (DSS v2.2). Fase 2 — Componente DSS.",
  status: "conformant",
  seal: "Pendente",
  phase: 2,
  auditDate: "N/A",
  goldenReference: "DssBadge",
  goldenContext: "DssTimeline",
}

const TOKENS_USED = [
    { token: "--dss-font-size-lg", description: "Token DSS" },
...
const DEFAULT_PROPS = [
    { prop: "title", value: 'Evento', type: typeof "Evento" },
    { prop: "subtitle", value: 'Data', type: typeof "Data" },
    { prop: "icon", value: 'check', type: typeof "check" }
]

// ─── Página ─────────────────────────────────────────────────────────────────

export default function DssTimelineEntryPage() {
  return (
            ...
            <ul className="mt-2 space-y-1 text-sm list-disc list-inside">
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssTimelineEntry/DssTimelineEntry.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssTimelineEntry/DSSTIMELINEENTRY_API.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  docs/Compliance/seals/DssTimelineEntry/
                </code>
              </li>
            </ul>
          </CardDescription>
