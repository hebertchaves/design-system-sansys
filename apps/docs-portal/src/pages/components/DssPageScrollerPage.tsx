...
// Componente: DssPageScroller — DSS v2.2
//
...
// consulte: packages/core/components/base/DssPageScroller/DssPageScroller.md
...
const COMPONENT_META = {
  ...
  kebabName: "dss-page-scroller",
  description: "Componente DssPageScroller do Design System Sansys (DSS v2.2). Fase 2 — Componente DSS.",
  status: "in-progress",
  seal: "Pendente",
  phase: 2,
  auditDate: "N/A",
  goldenReference: "DssBadge",
  goldenContext: "DssPageSticky",
}
...
export default function DssPageScrollerPage() {
  return (
            ...
            <ul className="mt-2 space-y-1 text-sm list-disc list-inside">
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssPageScroller/DssPageScroller.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssPageScroller/DSSPAGESCROLLER_API.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  docs/Compliance/seals/DssPageScroller/
                </code>
              </li>
            </ul>
          </CardDescription>
