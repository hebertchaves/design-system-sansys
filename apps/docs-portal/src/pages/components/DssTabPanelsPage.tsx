...
// Componente: DssTabPanels — DSS v2.2
//
...
// consulte: packages/core/components/base/DssTabPanels/DssTabPanels.md
...
const COMPONENT_META = {
  name: "DssTabPanels",
  kebabName: "dss-tab-panels",
  description: "Componente DssTabPanels do Design System Sansys (DSS v2.2). Fase 2 — Container de Painéis (Tab Panels Container).",
  status: "conforme",
  seal: "DSS v2.2",
  phase: 2,
...
export default function DssTabPanelsPage() {
  return (
            ...
            <ul className="mt-2 space-y-1 text-sm list-disc list-inside">
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssTabPanels/DssTabPanels.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssTabPanels/DSSTABPANELS_API.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  docs/Compliance/seals/DssTabPanels/
                </code>
              </li>
            </ul>
          </CardDescription>
