...
// consulte: packages/core/components/base/DssItem/DssItem.md
...
const COMPONENT_META = {
  name: "DssItem",
  kebabName: "dss-item",
  description: "Componente DssItem do Design System Sansys (DSS v2.2). Fase 1 — Layout/List.",
  status: "Em revisão",
  seal: "DSS v2.2",
  phase: 1,
  auditDate: "N/A",
...
const TOKENS_USED = [
    ...
    { token: "--dss-font-weight-medium", description: "Token DSS" },
    { token: "--dss-line-height-normal", description: "Token DSS" },
    { token: "--dss-line-height-tight", description: "Token DSS" },
...
export default function DssItemPage() {
  return (
            ...
            <ul className="mt-2 space-y-1 text-sm list-disc list-inside">
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssItem/DssItem.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssItem/DSSITEM_API.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  docs/Compliance/seals/DssItem/
                </code>
              </li>
            </ul>
          </CardDescription>
