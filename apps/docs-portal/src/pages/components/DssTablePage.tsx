...
// consulte: packages/core/components/base/DssTable/DssTable.md
...
const COMPONENT_META = {
  name: "DssTable",
  kebabName: "dss-table",
  description: "Componente DssTable do Design System Sansys (DSS).",
  status: "Em revisão",
  seal: "Pendente",
  phase: "?",
  auditDate: "N/A",
...
export default function DssTablePage() {
  return (
            ...
            <ul className="mt-2 space-y-1 text-sm list-disc list-inside">
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssTable/DssTable.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssTable/DSSTABLE_API.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  docs/Compliance/seals/DssTable/
                </code>
              </li>
            </ul>
          </CardDescription>
