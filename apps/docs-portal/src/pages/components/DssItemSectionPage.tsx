...
// Componente: DssItemSection — DSS v2.2
//
...
// consulte: packages/core/components/base/DssItemSection/DssItemSection.md
...
const COMPONENT_META = {
  name: "DssItemSection",
  kebabName: "dss-item-section",
  description: "Componente DssItemSection do Design System Sansys (DSS v2.2). Fase 2 — Container de Layout Interno.",
  status: "pronto-para-auditoria",
  seal: "Pendente",
  phase: 2,
  auditDate: "N/A",
  goldenReference: "DssAvatar",
...
export default function DssItemSectionPage() {
  return (
            ...
            <ul className="mt-2 space-y-1 text-sm list-disc list-inside">
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssItemSection/DssItemSection.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssItemSection/DSSITEMSECTION_API.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  docs/Compliance/seals/DssItemSection/
                </code>
              </li>
            </ul>
          </CardDescription>
