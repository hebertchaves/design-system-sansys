...
// Componente: DssSpace — DSS v2.2.0
//
...
// consulte: packages/core/components/base/DssSpace/DssSpace.md
...
const COMPONENT_META = {
  name: "DssSpace",
  kebabName: "dss-space",
  description: "Componente DssSpace do Design System Sansys (DSS v2.2.0). Fase 1 — Elemento de Layout puro nao interativo.",
  status: "conformant",
  seal: "DSS v2.2",
  phase: 1,
...
export default function DssSpacePage() {
  return (
            ...
            <ul className="mt-2 space-y-1 text-sm list-disc list-inside">
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssSpace/DssSpace.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssSpace/DSSSPACE_API.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  docs/Compliance/seals/DssSpace/
                </code>
              </li>
            </ul>
          </CardDescription>
