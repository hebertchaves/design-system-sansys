...
// Componente: DssCarousel — DSS v2.2
//
...
// consulte: packages/core/components/base/DssCarousel/DssCarousel.md
...
const COMPONENT_META = {
  name: "DssCarousel",
  kebabName: "dss-carousel",
  description: "Componente DssCarousel do Design System Sansys (DSS).",
  status: "Em revisão",
  seal: "Pendente",
  phase: "?",
  auditDate: "N/A",
...
export default function DssCarouselPage() {
  return (
            ...
            <ul className="mt-2 space-y-1 text-sm list-disc list-inside">
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssCarousel/DssCarousel.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssCarousel/DSSCAROUSEL_API.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  docs/Compliance/seals/DssCarousel/
                </code>
              </li>
            </ul>
          </CardDescription>
