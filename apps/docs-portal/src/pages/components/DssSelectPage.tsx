...
// Componente: DssSelect — DSS v2.2.0
//
...
// consulte: packages/core/components/base/DssSelect/DssSelect.md
...
const COMPONENT_META = {
  name: "DssSelect",
  kebabName: "dss-select",
  description: "Componente DssSelect do Design System Sansys (DSS v2.2.0). Fase 1 — Action Control interativo — campo de seleção.",
  status: "conformant",
  seal: "DSS v2.2",
  phase: 1,
...
export default function DssSelectPage() {
  return (
            ...
            <ul className="mt-2 space-y-1 text-sm list-disc list-inside">
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssSelect/DssSelect.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssSelect/DSSSELECT_API.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  docs/Compliance/seals/DssSelect/
                </code>
              </li>
            </ul>
          </CardDescription>
