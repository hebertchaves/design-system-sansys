...
// consulte: packages/core/components/base/DssRadio/DssRadio.md
...
const COMPONENT_META = {
  name: "DssRadio",
  kebabName: "dss-radio",
  description: "Componente DssRadio do Design System Sansys (DSS v2.2). Fase Fase 1 — Compact Control interativo.",
  status: "Aprovado",
  seal: "DSS v2.2",
  phase: "Fase 1",
  auditDate: "2026-02-05",
  goldenReference: "DssChip",
  goldenContext: "DssCheckbox",
}
...
export default function DssRadioPage() {
  return (
            ...
            <ul className="mt-2 space-y-1 text-sm list-disc list-inside">
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssRadio/DssRadio.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssRadio/DSSRADIO_API.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  docs/Compliance/seals/DssRadio/
                </code>
              </li>
            </ul>
          </CardDescription>
