...
// Componente: DssOptionGroup — DSS v2.2
//
...
// consulte: packages/core/components/base/DssOptionGroup/DssOptionGroup.md
...
const COMPONENT_META = {
  name: "DssOptionGroup",
  kebabName: "dss-option-group",
  description: "Componente DssOptionGroup do Design System Sansys (DSS v2.2). Fase 2 — Container de Seleção — Grupo de Controles (Radio, Checkbox ou Toggle).",
  status: "sealed",
  seal: "Pendente",
  phase: 2,
...
const DEFAULT_PROPS = [
    { prop: "type", value: 'radio', type: typeof "radio" }
]

// ─── Página ─────────────────────────────────────────────────────────────────

export default function DssOptionGroupPage() {
  return (
            ...
            <ul className="mt-2 space-y-1 text-sm list-disc list-inside">
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssOptionGroup/DssOptionGroup.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  packages/core/components/base/DssOptionGroup/DSSOPTIONGROUP_API.md
                </code>
              </li>
              <li>
                <code className="text-xs bg-muted px-1 rounded">
                  docs/Compliance/seals/DssOptionGroup/
                </code>
              </li>
            </ul>
          </CardDescription>
