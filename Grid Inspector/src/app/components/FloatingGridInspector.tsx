...
import { Grid3x3, Eye, Box, ChevronLeft, ChevronRight, Minimize2, Maximize2, X, ArrowLeftRight, ArrowUpDown, Layers, Info } from 'lucide-react';
import { useGridSystem } from '@/hooks';
import { useNestedGrid } from '@/app/contexts/NestedGridContext';
...
export function FloatingGridInspector() {
  ...
  if (panelSize === 'minimized') {
    return (
      <div className="fixed top-20 right-4 z-50 bg-white rounded-xl shadow-2xl border border-slate-200 w-[60px] overflow-hidden">
  ...
  return (
    <div className={`fixed top-20 right-4 z-50 bg-white rounded-xl shadow-2xl border border-slate-200 ${widthClass} transition-all duration-300 max-h-[calc(100vh-6rem)] flex flex-col`}>
      {/* Header */}
      ...
      <Tabs defaultValue="layout" className="w-full flex-1 flex flex-col overflow-hidden">
        <TabsList className="w-full grid grid-cols-4 rounded-none border-b border-slate-200 bg-slate-50 h-auto p-0 flex-shrink-0">
          <TabsTrigger 
            value="layout" 
          ...
          <TabsTrigger 
            value="advanced" 
            className="group rounded-none data-[state=active]:bg-gradient-to-b data-[state=active]:from-indigo-50 data-[state=active]:to-white data-[state=active]:shadow-none data-[state=active]:border-b-2 data-[state=active]:border-b-indigo-600 py-3 transition-all duration-300 hover:bg-indigo-50/30 relative overflow-hidden"
          >
              ...
              <AccordionItem value="breakpoints" className="border-b border-slate-100">
                ...
                <AccordionContent className="px-4 pb-3">
                  <div className="space-y-2">
                    ...
                    <ToggleGroup type="single" value={breakpoint} onValueChange={(v) => v && setBreakpoint(v as any)} className="grid grid-cols-2 sm:grid-cols-4 gap-1.5">
