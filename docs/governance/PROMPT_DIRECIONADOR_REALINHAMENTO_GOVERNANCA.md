...
Como o DSS deve ser um sistema autossuficiente e profissional ("falar por si só"), você deve executar o **realinhamento completo de 100% dos documentos de governança, guias técnicos e READMEs** para que eles reflitam com precisão absoluta o estado atual do ecossistema.
...
* **Instruções de Leitura:** Atualizar a seção *"Leitura Obrigatória (ANTES de criar qualquer componente)"* para refletir os caminhos reais dos guias no monorepo.
