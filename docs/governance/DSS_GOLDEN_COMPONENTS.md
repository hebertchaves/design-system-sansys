...
### Composição de Ícone — Cartão Base / CCI (16 Jun 2026)
...
> **Diretriz vinculante:** nenhum componente DSS reimplementa renderização de ícone. O glifo é responsabilidade do `DssIcon` → `QIcon`. Ver Composição de Ícones (Cartão Base do CLAUDE.md; contrato em DSS_ICON_COMPOSITION_CONTRACT.md) e CCI §3.

---

## 6. Documentos Relacionados

- [CLAUDE.md](../../CLAUDE.md) — Modelo Golden (Cartão Base — Auditoria; vinculante)
